...
// 2026-07-27: alpha 40, cti 20 (INFINITY8), blueguardian 35, ftmo 19, fundingpips 20. Nao deixar fallback velho.
...
const SCHEDULE: Record<string, Slot[]> = {
  ...
  "3": [{ firmId: "fn", off: 47, name: "FundedNext" }, { firmId: "blueguardian", off: 35, name: "Blue Guardian" }, { firmId: "cti", off: 20, name: "City Traders Imperium" }, { firmId: "futureselite", off: 30, name: "Futures Elite" }],
