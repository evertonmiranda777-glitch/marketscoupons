...
const SCHEDULE: Record<string, Slot[]> = {
  ...
  "6": [{ firmId: "apex", off: 90, name: "Apex Trader Funding" }, { firmId: "bulenox", off: 89, name: "Bulenox" }, { firmId: "toponefutures", off: 60, name: "Top One Futures" }, { firmId: "aquafutures", off: 60, name: "Aqua Futures" }],
  "0": [{ firmId: "blueberryfutures", off: 60, name: "Blueberry Futures" }, { firmId: "goat", off: 50, name: "Goat Funded Futures" }, { firmId: "tradeday", off: 50, name: "TradeDay" }, { firmId: "fn", off: 40, name: "FundedNext" }],
};
