...
// 2026-07-27: alpha 40, cti 20 (INFINITY8), blueguardian 25 (BG25), ftmo 19, fundingpips 20. Nao deixar fallback velho.
...
const SCHEDULE: Record<string, Slot[]> = {
  "1": [{ firmId: "apex", off: 90, name: "Apex Trader Funding" }, { firmId: "bulenox", off: 89, name: "Bulenox" }, { firmId: "toponefutures", off: 60, name: "Top One Futures" }, { firmId: "aquafutures", off: 45, name: "Aqua Futures" }],
  ...
  "6": [{ firmId: "funded-futures-family", off: 80, name: "Funded Futures Family" }, { firmId: "bulenox", off: 89, name: "Bulenox" }, { firmId: "toponefutures", off: 60, name: "Top One Futures" }, { firmId: "aquafutures", off: 45, name: "Aqua Futures" }],
...
const COUPONS: Record<string, string | null> = { apex: "MARKET", bulenox: "MARKET89", toponefutures: "MARKET", aquafutures: "MIDSUMMER", blueberryfutures: "MARKET-7652C", goat: "MARKET", tradeday: "MARKETS", e2t: "MARKETSCOUPONS", fn: "MARKET", blueguardian: "MARKET", cti: "INFINITY8", futureselite: null, brightfunded: "CLNLTPxtT4Sok0PzHaRIIQ", alphafutures: "MARKETS026158", fundingpips: null, ftmo: null, e8: "E8", the5ers: null, "funded-futures-family": "MARKET" };
