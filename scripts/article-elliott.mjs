...
const slug = 'ondas-de-elliott-guia-completo';

const meta = {
  title: 'Ondas de Elliott: O Guia Completo da Teoria Fractal de Mercados',
  slug,
...
<img src="${cdn(slug, 'wave-3-setup.jpeg')}" alt="Setup de entrada na onda 3 com Fibonacci 0.618 da onda 1 como zona de retorno">
...
<p><em>Para aplicar Elliott em desafios de prop firm, leia também o <a href="/guides/gerenciamento-drawdown">guia de gerenciamento de drawdown</a> e o <a href="/blog/metodo-wyckoff-guia-completo">método Wyckoff</a> que dá o componente volumétrico que confirma cada onda.</em></p>
`.trim();

const stats = writeArticle(meta, body);
console.log('Elliott:', JSON.stringify(stats, null, 2));
