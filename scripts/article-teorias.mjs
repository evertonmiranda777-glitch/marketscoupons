...
const slug = 'teorias-dos-mercados-dow-emh';

const meta = {
  title: 'Teorias dos Mercados: De Charles Dow ao Reflexive Theory de Soros',
  slug,
  category: 'Educação',
  level: 'intermediario',
  read_time: '15 min',
...
<p><em>Para aplicar essas teorias em trading prático, leia <a href="/blog/metodo-wyckoff-guia-completo">método Wyckoff</a>, <a href="/blog/vpa-volume-price-analysis">VPA</a> e <a href="/blog/introducao-analise-tecnica">introdução à análise técnica</a>.</em></p>
`.trim();

const stats = writeArticle(meta, body);
console.log('Teorias:', JSON.stringify(stats, null, 2));
