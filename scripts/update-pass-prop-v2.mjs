...
const h=fs.readFileSync('data/preview/blog-v2/how-to-pass-prop-firm.v2.html','utf8');
...
const post={slug:'how-to-pass-prop-firm',lang:'en',title:'How to Pass a Prop Firm Evaluation, The Realistic Playbook',category:'Prop Firms',level:'beginner',read_time:'46 min',icon:'🎯',cover_url:'https://www.marketscoupons.com/img/blog-heros/how-to-pass-prop-firm.jpg',excerpt:'The realistic guide to passing prop firm evals, drawdown mechanics, consistency rules, daily routines, multi-account scaling, and the 24-month income roadmap.',sort_order:27,author:'Markets Coupons Research',body,active:true};
