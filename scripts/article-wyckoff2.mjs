...
const slug = 'wyckoff-2-volume-profile-order-flow';

const meta = {
  title: 'Wyckoff 2.0: Estruturas, Volume Profile e Order Flow Modernos',
  slug,
  ...
  excerpt: 'Wyckoff 2.0 é a fusão dos esquemas clássicos de acumulação/distribuição com Volume Profile, Cumulative Delta e Order Flow. Este guia mostra como traders profissionais combinam ferramentas antigas e modernas para ler intenção institucional em micro-segundos.',
  cover_url: cdn(slug, 'hero.jpeg')
};

const body = `
<img src="${cdn(slug, 'hero.jpeg')}" alt="Volume Profile sobreposto a estrutura Wyckoff de acumulação">
...
<p><em>Para fundamentos antes do Wyckoff 2.0, leia <a href="/blog/metodo-wyckoff-guia-completo">método Wyckoff clássico</a> e <a href="/blog/vpa-volume-price-analysis">VPA</a>.</em></p>
`.trim();

const stats = writeArticle(meta, body);
console.log('Wyckoff 2.0:', JSON.stringify(stats, null, 2));
