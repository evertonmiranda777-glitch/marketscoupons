...
const slug = 'indicadores-tecnicos-guia-completo';

const meta = {
  title: 'Indicadores Técnicos: O Guia Definitivo dos 12 Mais Usados na Mesa Profissional',
  slug,
...
<p><em>Para entender como indicadores se conectam com leitura institucional, veja nosso <a href="/blog/vpa-volume-price-analysis">guia VPA</a> e <a href="/blog/metodo-wyckoff-guia-completo">método Wyckoff</a>. Para aplicação em prop firm, leia o <a href="/guides/gerenciamento-drawdown">guia de drawdown</a>.</em></p>
`.trim();

const stats = writeArticle(meta, body);
console.log('Indicadores:', JSON.stringify(stats, null, 2));
