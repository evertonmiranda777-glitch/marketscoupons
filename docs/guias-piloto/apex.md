---
title: "Apex Trader Funding Review 2026: Rules, Pricing, Payouts & MARKET Discount"
slug: apex-trader-funding-review
meta_description: "Full Apex Trader Funding review for 2026: every account size, the 50% consistency rule, trailing drawdown math, payout cycle, and the MARKET lifetime coupon. Updated April 2026."
...
target_audience: "Futures traders evaluating prop firms, existing Apex customers looking for rule clarifications, beginners researching first funded account"
...
# Apex Trader Funding Review 2026: Rules, Pricing, Payouts & MARKET Discount

*Last updated: April 17, 2026 — 14 min read*

![Apex Trader Funding Review 2026 — editorial hero with candlestick chart and orange accent](./img/apex-hero.png)
...
![Intraday trailing drawdown vs End-of-Day trailing drawdown comparison diagram](./img/apex-drawdown-diagram.png)
...
**How it works:**
- The threshold starts at: starting balance − max drawdown (e.g., $50,000 − $2,000 = $48,000)
- As your account hits new highs (realized OR unrealized), the threshold follows upward
- The threshold **never moves down**
- If the account balance touches the threshold at any moment, all positions are automatically liquidated
...
- **Evaluation (Rithmic & Wealthcharts):** Locks when balance reaches profit target + max drawdown (for the 50K, that's $55,000 → threshold fixed at $53,000)
- **Evaluation (Tradovate):** Never locks — trails indefinitely
- **Performance Account:** Locks when threshold reaches starting balance + $100 (for the 50K PA, that's $50,100)
...
**How it works:**
- Same starting threshold as Intraday (balance − max drawdown)
- At 4 PM CT, if your closing balance is higher than any previous close, the threshold moves up
- Within the session, the threshold is fixed — you have room to breathe
...
- Lowest-latency data feed
- Works with virtually every futures front-end
- NinjaTrader connection included at no extra cost ($75 value)
- Real-time CME data fees included ($55 value)
...
- No software install (runs in browser)
- Mobile app included
- Access to EUREX (DAX, Euro Stoxx, Bunds) — Rithmic does not currently route these on Apex
...
- Clean, modern UI
- Indicator library built in
- No separate NinjaTrader license needed
...
- Hold positions through the 4:59 PM CT daily reset window
- Hold positions through the 5:00 PM CT weekend close (Friday)
- Exceed max contract size at any moment
- Use copy-trading automation across Apex accounts during evaluation (permitted only on PA)
...
![Apex 50% consistency rule visualization showing the formula Highest Day divided by Total Profit](./img/apex-consistency-diagram.png)
...
**Example:**
- You're on a 50K PA
- Your best day: $1,500 profit
- Your total profit since account start (or last payout): $2,500
...
![Apex 50K Performance Account scaling tiers from Level 1 to Level 4 with contract size and DLL progression](./img/apex-scaling-tiers.png)
...
- Profit must exceed the **minimum payout threshold** ($500 for the first few payouts)
- Consistency rule must pass
- At least 5 trading days since your last payout (or first trade)
...
- **Micro E-mini S&P 500 (MES)** — $5 per point
- **E-mini Nasdaq-100 (NQ)** — $20 per point
- **Micro E-mini Nasdaq-100 (MNQ)** — $2 per point
- **Mini-Dow (YM)** — $5 per point
...
- **Micro Crude (MCL)** — $100 per point
- **Natural Gas (NG)** — $10,000 per point
- **E-mini Natural Gas (QG)** — $2,500 per point

### Metals *(availability varies — currently restricted on some COMEX contracts)*
- **Gold (GC)** — $100 per point
- **Micro Gold (MGC)** — $10 per point
- **Silver (SI)** — $5,000 per point
...
![Apex Trader Funding pros vs cons side-by-side comparison](./img/apex-pros-cons.png)

### Pros

- **Lifetime discount** via the MARKET coupon — roughly 90% off every purchase, not a first-order promo
- **100% profit split** — no cut taken on PA earnings
- **Fastest-to-fund:** Pass in 1 day minimum, activate same day
- **No time minimum to hold trades** — scalpers are fine
- **News trading permitted** — no rule against trading NFP, FOMC, or CPI
- **Up to 20 accounts per trader** — scale horizontally
- **Platform choice:** Rithmic, Tradovate, or Wealthcharts
- **Track record of payouts:** Averaging over $1M/month to customers since 2023
- **No ongoing subscription** — evaluation fee and activation fee are both one-time

### Cons

- **Intraday Trailing Drawdown is unforgiving** — unrealized PnL counts, and once you breach you're out with no refund
- **50% consistency rule locks payouts** — a single big winning day can delay payouts for weeks
- **No reset option on new accounts** — one breach costs you the full evaluation fee
- **30-day evaluation window** — shorter than the industry-standard "unlimited time"
- **First 5 payouts capped at $1,500** — reaching large payouts takes time
- **Safety net slows early payouts** — minimum PA balance must be maintained
- **Legacy vs new dual system can confuse** — accounts bought before March 1, 2026 follow different rules
- **Limited instrument list during COMEX restrictions** — metals availability fluctuates
...
**1. Active futures scalper on ES, NQ, or CL**
The 1-day pass minimum, permissive news policy, and tight-but-fair drawdown math reward fast, high-frequency traders.

**2. Swing trader with multi-account strategy**
Run 5 EOD 50K accounts, use the built-in scaling to grow each, and collect parallel payouts every 5 trading days.

**3. Price-sensitive trader starting out**
The $19.90 entry with MARKET is the cheapest serious entry point in futures prop trading. You can budget your first 3–4 evaluation attempts for under $80 total.

**4. Trader who wants no split**
Most firms take 10–25% of PA profits. Apex's 100% split on simulated funded accounts is the highest you'll find.

**Who should look elsewhere:**
- If you prefer forex or CFDs, Apex doesn't offer them — consider FTMO or FundingPips instead
- If you want an unlimited time evaluation, consider Take Profit Trader (no time limit)
- If the Intraday Trail feels too punishing, pick Apex EOD or try Bulenox's static drawdown model
...
- **Scalpers and intraday momentum traders:** Intraday Trail
- **Swing traders or anyone carrying positions through the day:** EOD Trail

### Step 4: Choose platform

- **NinjaTrader user:** Rithmic
- **Browser/mobile user:** Tradovate
- **All-in-one preference:** Wealthcharts
...
- [Bulenox Review: Static Drawdown Alternative](/guides/bulenox-review)
- [FTMO vs Apex: Forex vs Futures Prop Firms](/guides/ftmo-vs-apex)
- [How to Pass Any Prop Firm Evaluation](/guides/pass-prop-firm-evaluation)
- [Prop Firm Calculator: Position Size by Account Size](/tools/position-calculator)
- [Compare All Prop Firms](/compare)
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Article",
      "@id": "https://www.marketscoupons.com/guides/apex-trader-funding-review#article",
      "headline": "Apex Trader Funding Review 2026: Rules, Pricing, Payouts & MARKET Discount",
      "description": "Full Apex Trader Funding review for 2026: every account size, the 50% consistency rule, trailing drawdown math, payout cycle, and the MARKET lifetime coupon.",
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Is Apex Trader Funding legit?",
          "acceptedAnswer": { "@type": "Answer", "text": "Yes. Apex has been operational since 2019, is rated 4.4/5 on Trustpilot across 19,000+ reviews, and publishes monthly customer payout totals averaging over $1M per month since January 2023." }
        },
        {
          "@type": "Question",
          "name": "How much does Apex Trader Funding cost?",
          "acceptedAnswer": { "@type": "Answer", "text": "Entry starts at $19.90 for the 25K account with the MARKET coupon (90% off the $199 regular price). A one-time $85 activation fee applies after passing the evaluation. No recurring billing." }
        },
        {
          "@type": "Question",
          "name": "What is the Apex consistency rule?",
          "acceptedAnswer": { "@type": "Answer", "text": "The 50% consistency rule means your single largest profitable trading day cannot exceed 50% of your total accumulated profit at the time of a payout request. If it does, the payout is locked until total profit grows enough to bring the ratio below 50%." }
        },
        {
          "@type": "Question",
          "name": "How long does it take to pass the Apex evaluation?",
          "acceptedAnswer": { "@type": "Answer", "text": "Minimum 1 trading day. Maximum 30 days from purchase. Most traders pass within 5 to 15 trading days." }
        },
        {
          "@type": "Question",
          "name": "Does Apex pay out?",
          "acceptedAnswer": { "@type": "Answer", "text": "Yes. Payouts are released on a 5-trading-day cycle, with average processing of 2 to 5 business days after approval. Apex has paid over $100 million cumulatively since 2022." }
        },
        {
          "@type": "Question",
          "name": "What is the Apex profit split?",
          "acceptedAnswer": { "@type": "Answer", "text": "100% on simulated funded Performance Accounts. Apex does not take a cut of PA earnings, only the one-time activation fee." }
        },
        {
          "@type": "Question",
          "name": "Can I trade news on Apex?",
          "acceptedAnswer": { "@type": "Answer", "text": "Yes. Apex does not restrict news trading. NFP, CPI, FOMC, and all high-impact events are permitted." }
        },
        {
          "@type": "Question",
          "name": "What platforms does Apex support?",
          "acceptedAnswer": { "@type": "Answer", "text": "Three platforms: Rithmic (works with NinjaTrader, Quantower, ATAS, MotiveWave), Tradovate (browser-based), and Wealthcharts (all-in-one)." }
        }
      ]
    },
    {
      "@type": "HowTo",
      "name": "How to Get Started with Apex Trader Funding",
      "step": [
        { "@type": "HowToStep", "name": "Use the MARKET affiliate link", "text": "Visit Apex Trader Funding via the affiliate link to pre-apply the MARKET lifetime coupon." },
        { "@type": "HowToStep", "name": "Pick your account size", "text": "Start with the 50K account for a balanced profit target and drawdown." },
        { "@type": "HowToStep", "name": "Choose drawdown type", "text": "Intraday Trail for scalpers, EOD Trail for swing traders." },
        { "@type": "HowToStep", "name": "Choose platform", "text": "Rithmic for NinjaTrader users, Tradovate for browser, Wealthcharts for all-in-one." },
        { "@type": "HowToStep", "name": "Enter MARKET coupon at checkout", "text": "Confirm the discount applies before completing payment." },
        { "@type": "HowToStep", "name": "Pass the evaluation", "text": "Hit the profit target with consistent modest gains to meet the 50% consistency rule later." },
        { "@type": "HowToStep", "name": "Pay the $85 activation fee within 7 days", "text": "Miss the 7-day window and the pass is lost." },
        { "@type": "HowToStep", "name": "Trade the PA for your first payout", "text": "Minimum 5 trading days from activation. Keep largest day under 50% of total profit." }
      ]
    }
  ]
}
...
**Word count:** ~3,500 | **Reading time:** 14 min | **Schema types:** Article, Review, FAQPage, HowTo
