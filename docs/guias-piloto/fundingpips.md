---
title: "FundingPips Review 2026: Dubai's Fastest-Growing Forex Prop Firm"
description: "Complete FundingPips review: Zero, 1-step, 2-step programs, 100% profit split, 1:100 leverage, $300K scaling, Trustpilot 4.5 across 52,513 reviews. Code HELLO for 20% off."
slug: fundingpips-review
canonical: https://www.marketscoupons.com/guides/fundingpips-review
...
> **Quick Summary**
> **Type:** Forex prop firm (Dubai, simulated-capital model)
> **Best for:** Forex traders wanting flexible evaluation paths + high leverage
> **Profit split (rewards):** **60% / 80% / 90% / 100%** depending on payout cycle
> **Max simulated capital:** **$300,000** through scaling
> **Leverage:** **1:100** (forex majors)
> **Trustpilot:** ★ 4.5 · 52,513 reviews
> **Active offer:** **Code HELLO** → 20% OFF first purchase

---

## Table of Contents

1. [What is FundingPips?](#what-is)
2. [The Three Challenge Types](#programs)
3. [2-Step Evaluation, Student, Practitioner, Master](#two-step)
4. [1-Step and Zero Programs](#one-step-zero)
5. [Pricing (All Account Sizes)](#pricing)
6. [Trading Objectives and Rules](#rules)
7. [Reward Cycles, How You Get Paid](#rewards)
8. [Platforms and Leverage](#platforms)
9. [Scaling to $300K](#scaling)
10. [FundingPips vs FTMO vs FundedNext](#vs-others)
11. [Pros and Cons](#pros-cons)
12. [Who is FundingPips For?](#who-for)
13. [How to Pass FundingPips (Step-by-Step)](#how-to-pass)
14. [FAQ](#faq)

---

## <a id="what-is"></a>What is FundingPips?
...
## <a id="programs"></a>The Three Challenge Types

![FundingPips three challenge programs](./img/fundingpips-programs.png)
...
![FundingPips 2-step evaluation phases](./img/fundingpips-phases.png)
...
## <a id="one-step-zero"></a>1-Step and Zero Programs
...
## <a id="rules"></a>Trading Objectives and Rules
...
## <a id="rewards"></a>Reward Cycles, How You Get Paid

![FundingPips reward cycle options](./img/fundingpips-rewards.png)
...
## <a id="scaling"></a>Scaling to $300K
...
1. Trade the Master account profitably for a defined period (typically 2 consecutive profitable payout cycles, ~8% profit over 4 months)
2. Request scaling through the dashboard
3. Simulated capital is increased by a set percentage (commonly **+25% per scale tier**)
4. Continue until you reach the $300K cap
...
![FundingPips pros and cons comparison](./img/fundingpips-pros-cons.png)
...
## <a id="who-for"></a>Who is FundingPips For?
...
## <a id="how-to-pass"></a>How to Pass FundingPips (Step-by-Step)

### Step 1, Choose Your Challenge Type

**Beginner or budget-conscious:** pick **2-Step**. Lower per-phase targets (8% + 5%), cheapest price.
**Experienced day-trader:** pick **1-Step**. Single 8% target, faster.
**Proven edge, want to skip evaluation:** pick **Zero**. Straight to Master.
...
- [The5ers Review](./the5ers-review), scale to $4M, 1 / 2 / 3-step programs
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Article",
      "headline": "FundingPips Review 2026: Dubai's Fastest-Growing Forex Prop Firm",
      "description": "Complete FundingPips review: Zero, 1-step, 2-step programs, 100% profit split, 1:100 leverage, $300K scaling, Trustpilot 4.5 across 52,513 reviews. Code HELLO for 20% off.",
      ...
      "mainEntityOfPage": "https://www.marketscoupons.com/guides/fundingpips-review"
    },
    {
      "@type": "Review",
      ...
      "author": { "@type": "Organization", "name": "Markets Coupons" },
      "reviewBody": "FundingPips is a Dubai-based forex prop firm with 2M+ traders, $200M+ paid globally, and Trustpilot 4.5/52,513 reviews. Three evaluation paths (Zero/1-Step/2-Step), 1:100 leverage, up to 100% profit split on monthly cycle, scaling to $300K. Code HELLO for 20% off."
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        { "@type": "Question", "name": "Is FundingPips legit?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. FundingPips operates since 2022, has 52,513 Trustpilot reviews at 4.5/5, paid $200M+ to traders, serves 2M+ traders in 195 countries." } },
        { "@type": "Question", "name": "What's the FundingPips coupon?", "acceptedAnswer": { "@type": "Answer", "text": "Code HELLO gets 20% OFF your first purchase on any FundingPips challenge." } },
        { "@type": "Question", "name": "What leverage does FundingPips offer?", "acceptedAnswer": { "@type": "Answer", "text": "1:100 on forex majors. Lower on metals (1:50), indices (1:20), and crypto CFDs (1:2)." } },
        { "@type": "Question", "name": "Can I use EAs on FundingPips?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, expert advisors are permitted on MT5 and cTrader with restrictions on HFT and copy trading." } },
        { "@type": "Question", "name": "What's the difference between Zero, 1-Step, and 2-Step?", "acceptedAnswer": { "@type": "Answer", "text": "Zero skips evaluation. 1-Step has a single 8% target phase. 2-Step has two phases (8% then 5%) and is cheapest." } }
      ]
    },
    {
      "@type": "HowTo",
      "name": "How to pass the FundingPips evaluation",
      "step": [
        { "@type": "HowToStep", "name": "Choose challenge type", "text": "Pick Zero (no evaluation), 1-Step (single 8% target), or 2-Step (two phases: 8% + 5%)." },
        { "@type": "HowToStep", "name": "Pick account size", "text": "Choose $5K, $10K, $25K, $50K, or $100K simulated capital." },
        { "@type": "HowToStep", "name": "Apply code HELLO", "text": "Enter HELLO at checkout for 20% off your first purchase." },
        { "@type": "HowToStep", "name": "Respect drawdown", "text": "Stay within 10% max loss and 5% max daily loss. Trade minimum 3 days." },
        { "@type": "HowToStep", "name": "Hit profit target", "text": "Reach 8% (Phase 1) and 5% (Phase 2 if 2-Step) to advance to Master." },
        { "@type": "HowToStep", "name": "Pick reward cycle", "text": "Choose weekly (60%), bi-weekly (80%), on-demand (90%), or monthly (100%) payout cycle." },
        { "@type": "HowToStep", "name": "Scale to $300K", "text": "After consecutive profitable cycles, request scaling in +25% tiers toward the $300K ceiling." }
      ]
    }
  ]
}
