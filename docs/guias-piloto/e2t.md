...
description: "Complete Earn2Trade review covering Trader Career Path, Gauntlet Mini, pricing, rules, drawdown, and payouts. 9+ years, 6,400+ traders funded in 2025, Trustpilot 4.7."
slug: earn2trade-review
canonical: https://www.marketscoupons.com/guides/earn2trade-review
...
> **Quick Summary**
> **Type:** Futures prop firm (CME, COMEX, NYMEX, CBOT only)
> **Best for:** Disciplined futures traders who value structure, education, and a clear progression path
> **Profit split:** Up to 80%, scales with live account upgrades
> **Max funding:** $200K Gauntlet Mini / $400K Trader Career Path (scaled)
> **Drawdown:** EOD (End-of-Day), trailing until highest close, then static
> **Trustpilot:** ★ 4.7 · 4,751 reviews
> **Active offer:** 50% off all subscriptions + up to 35% off resets

---

## Table of Contents

1. [What is Earn2Trade?](#what-is-earn2trade)
2. [Trader Career Path vs Gauntlet Mini](#tcp-vs-gauntlet)
3. [Pricing (All Account Sizes)](#pricing)
4. [How EOD Drawdown Works](#eod-drawdown)
5. [Trader Career Path, The Progression Ladder](#progression-ladder)
6. [Gauntlet Mini, 10-Day Intraday Test](#gauntlet-mini)
7. [Profit Split and Payouts](#profit-split)
8. [Platforms and Data Feeds](#platforms)
9. [Allowed Instruments (Futures Only)](#allowed-instruments)
...
## <a id="what-is-earn2trade"></a>What is Earn2Trade?
...
![Trader Career Path vs Gauntlet Mini comparison](./img/e2t-tcp-vs-gauntlet.png)
...
## <a id="eod-drawdown"></a>How EOD Drawdown Works

![Earn2Trade EOD drawdown mechanics](./img/e2t-drawdown.png)
...
1. **Start:** Balance = $100,000. Drawdown floor = $97,000 (starting balance − $3K).
2. **You close +$1,500 one day.** New balance = $101,500. Floor moves up to **$98,500** ($101,500 − $3,000). But only at end of day, intraday swings don't move the floor.
3. **You close +$2,000 another day.** Balance = $103,500. Floor moves to **$100,500**. Crossed "starting balance" milestone, the floor now freezes at $100,500 forever.
4. **You close −$500.** Balance = $103,000. Floor stays at $100,500 (no move back down).
...
## <a id="progression-ladder"></a>Trader Career Path, The Progression Ladder
...
## <a id="gauntlet-mini"></a>Gauntlet Mini, 10-Day Intraday Test
...
## <a id="profit-split"></a>Profit Split and Payouts

Earn2Trade uses a **real brokerage** live account model, not pure simulated funding. After passing:

1. You receive a **live account at one of the partner brokerages** (Tradovate, NinjaTrader, Finamark).
2. You trade live capital (backed by Earn2Trade's partner firm, not your own money).
3. You keep **80% of profits** on the first live tier. Scaling up the ladder can push this higher.
...
## <a id="platforms"></a>Platforms and Data Feeds
...
## <a id="allowed-instruments"></a>Allowed Instruments (Futures Only)
...
![Earn2Trade pros and cons](./img/e2t-pros-cons.png)
  ...
  "@graph": [
    {
      ...
      "mainEntityOfPage": "https://www.marketscoupons.com/guides/earn2trade-review"
    },
    {
      "@type": "Review",
      ...
      "author": { "@type": "Organization", "name": "Markets Coupons" },
      "reviewBody": "Earn2Trade is one of the longest-running futures prop firms (9+ years, 6,400+ traders funded in 2025, Trustpilot 4.7 / 4,751 reviews). Offers Trader Career Path with scaling up to $400K and the Gauntlet Mini 10-day intraday test. Real brokerage partnerships after passing."
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        { "@type": "Question", "name": "Is Earn2Trade legit?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Earn2Trade LLC is Wyoming-registered, operating since 2016, with 4,751 Trustpilot reviews at 4.7/5 and publicly disclosed pass rate (8.89% in 2025)." } },
        { "@type": "Question", "name": "How much does Earn2Trade cost?", "acceptedAnswer": { "@type": "Answer", "text": "Monthly subscription: $150 (TCP25), $190 (TCP50), $350 (TCP100). 50% off current promo applies." } },
        { "@type": "Question", "name": "What instruments are allowed?", "acceptedAnswer": { "@type": "Answer", "text": "Futures only on CME, COMEX, NYMEX, CBOT. No forex, stocks, CFDs, or spot crypto." } },
        { "@type": "Question", "name": "What's the pass rate?", "acceptedAnswer": { "@type": "Answer", "text": "8.89% in 2025, publicly disclosed. Based on subscriptions passed vs subscriptions sold." } }
      ]
    },
    {
      "@type": "HowTo",
      "name": "How to pass the Earn2Trade Trader Career Path evaluation",
      "step": [
        { "@type": "HowToStep", "name": "Choose plan", "text": "Pick TCP25, TCP50, or TCP100 based on capital risk tolerance. Apply 50% off code at checkout." },
        { "@type": "HowToStep", "name": "Trade futures only", "text": "Only instruments on CME, COMEX, NYMEX, CBOT. No forex, stocks, CFDs." },
        { "@type": "HowToStep", "name": "Hit profit target", "text": "TCP25: $1,500. TCP50: $3,000. TCP100: $6,000. Unlimited time." },
        { "@type": "HowToStep", "name": "Avoid EOD drawdown", "text": "Never close end-of-day more than EOD drawdown below highest close. Open equity counts at session close." },
        { "@type": "HowToStep", "name": "Transition to live account", "text": "After passing, complete broker KYC (Tradovate, NinjaTrader, or Finamark) and begin live trading with 80% profit split." }
      ]
    }
  ]
}
