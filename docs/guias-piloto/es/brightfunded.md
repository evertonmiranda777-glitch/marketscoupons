---
title: "BrightFunded Review 2026: Drawdown Fijo, 100% Split, Tokens Trade2Earn"
description: "Review completa BrightFunded: drawdown fijo del 10%, profit split hasta 100%, escala hasta US$400K, programa de fidelidad Trade2Earn en tokens, MT5/cTrader/DXtrade. Cupones NEW15 / BF10 hasta 15% OFF."
slug: brightfunded-review
canonical: https://www.marketscoupons.com/es/guides/brightfunded-review
published: 2026-04-17
updated: 2026-04-17
author: Markets Coupons Team
lang: es
tags: [brightfunded, prop firm forex, trade2earn, drawdown fijo, mt5]
---

# BrightFunded Review 2026: Drawdown Fijo, 100% Split, Tokens Trade2Earn

*Última actualización: 17 de abril de 2026 · 12 min de lectura · Por Markets Coupons Team*

![BrightFunded prop firm forex - ilustración hero](../img/brightfunded-hero.png)
...
> **Ideal para:** Traders que quieren drawdown fijo + recompensas de fidelidad en tokens
> **Profit split:** Hasta **100%** (incluyendo 15% de recompensa sobre ganancias de evaluación)
> **Escala máxima:** **US$400.000**
> **Drawdown:** **10% max loss fijo / 5% max daily loss** (no trailing)
> **Plataformas:** MetaTrader 5, cTrader, DXtrade
> **Trustpilot:** Rating actualmente no disponible en Trustpilot (532 reviews visibles)
> **Promociones activas:** **NEW15** (nuevos clientes, 15% OFF) / **BF10** (existentes, 10% OFF)
...
13. [Una nota sobre Trustpilot](#trustpilot-note)
14. [FAQ](#faq)
...
- **Más de US$13M en pagos totales a traders**
- **Más de 30 empleados** en 3 oficinas (sede en Dubái + Ámsterdam + Varsovia)
- **Consejo asesor** con experiencia en Bancos Centrales y Prop Trading
- **Soporte en vivo 24/7** en varios idiomas
- **Payouts semanales** en la cuenta fondeada (primero tras 7 días de operación fondeada)
- **Procesamiento de payout garantizado en 24 horas**

La propuesta: **"Te recompensamos por operar, no solo por ganar."** La **Recompensa del 15% sobre Ganancias de Evaluación** (dinero pagado sobre las ganancias de las fases de evaluación) y **Trade2Earn** (tokens ganados por lote operado, independiente de P&L) son las dos características que personifican ese posicionamiento y no existen en FTMO, FundedNext o FundingPips en esta forma.

---

## <a id="evaluation"></a>La estructura 2-Step Evaluation
...
**Por qué algunas firmas lo evitan:** el drawdown fijo es más favorable al trader, lo que significa tasas de payout más altas del lado de la firma. BrightFunded absorbe esto para diferenciarse.

---

## <a id="pricing"></a>Precios (todos los tamaños de cuenta)

BrightFunded precia en **EUR** (la firma está registrada en Dubái pero opera globalmente). Precios de referencia para el 2-Step Classic:

| Tamaño de cuenta | Capital simulado | Precio de referencia (EUR) |
|---|---|---|
| **US$5K** | US$5.000 | ~€39 |
| **US$10K** | US$10.000 | ~€59 |
...
- **Fase 2 es gratis** (sin cuota adicional entre fases)
- **Fase fondeada es gratis** (una vez accedida, sin suscripción mensual)

> **Ejemplo de precio:** US$100K 2-Step a €497 base → **€422 con NEW15**. Si pasas y alcanzas un solo payout del 8% al 100% split (US$8.000), lo cobras en efectivo. El primer payout reembolsa la cuota; todo después es ganancia pura.
...
Esto es único en la industria. **Durante las fases de evaluación**, BrightFunded te paga el **15% de tus ganancias de evaluación en efectivo** en tu primer payout de fase fondeada.

**Cómo funciona:**
- Pasas la Fase 1 con +US$10.000 en un desafío de US$100K → elegible a US$1.500 (15%) de recompensa de evaluación
...
El split inicial en la fase fondeada es **80%**, escalando vía canje de tokens Trade2Earn y ciclos rentables consecutivos. Los top performers alcanzan el **100%**.

---

## <a id="trade2earn"></a>Programa de fidelidad en tokens Trade2Earn
...
- **Upgrades de profit split** (hacia el techo de 100%)
- **Evaluaciones gratis** (si fallas y quieres reintentar sin pagar)
- **Otros beneficios del dashboard** (variables a lo largo del tiempo)

**Por qué importa:** para traders activos (scalpers, day traders) ejecutando 50+ trades por semana, los tokens pueden reducir significativamente el costo efectivo de operar en BrightFunded. Un trader que falla en una evaluación de US$100K pero tiene suficientes tokens para un restart gratis, efectivamente obtiene un segundo intento sin costo adicional.

---

## <a id="scaling"></a>Escala hasta US$400K

![BrightFunded camino de escala](../img/brightfunded-scaling.png)

BrightFunded anuncia **escala de hasta US$400.000** en capital fondeado. La mecánica sigue el patrón típico de las Prop Firms:

1. Pasa la evaluación 2-Step Classic en el tamaño inicial elegido
2. Opera la cuenta fondeada rentablemente por 2+ ciclos de payout rentables consecutivos
3. El saldo de cuenta escala en tiers definidos (incremento típico: **+25% por tier**)
4. Continúa hasta alcanzar el techo de US$400K

Comparado con competidores:
- **FundingPips** escala hasta **US$300K** (techo menor)
- **FundedNext** escala hasta **US$300K** (techo menor)
...
**1:100 es el apalancamiento estándar retail-grade** entre esta generación de Prop Firms (iguala FundingPips y FundedNext; mayor que 1:30 de The5ers).
...
|---|---|---|---|
| **Fundación** | 2022 | 2015 | 2022 |
| **Trustpilot** | Rating no disponible | 4,8 / 41K+ | 4,5 / 52K+ |
| **Tipo de drawdown** | **Fijo** | Trailing en cuenta fondeada | Fijo |
| **Profit split** | Hasta 100% | 80→90% escalonado | 60–100% (ciclo) |
| **Techo de escala** | US$400K | US$2M | US$300K |
| **Días mínimos de trading** | 5 por fase | 4 Fase 1 / 4 Fase 2 | 3 por fase |
| **Recompensa de ganancia de evaluación** | **15% bonus en efectivo** | Ninguna | Ninguna |
| **Programa de fidelidad** | Tokens Trade2Earn | Ninguno | Ninguno |
| **Plataformas** | MT5, cTrader, DXtrade | MT4, MT5, cTrader, DXtrade | MT5, Match-Trader, cTrader |
| **Garantía de payout** | 24h | 1–2 días | Rápido, sin rechazos |
| **Payout USDC** | **Sí** | No | No |

**Quién elige BrightFunded:** traders que valoran **drawdown fijo** + la **recompensa del 15% de evaluación** + **fidelidad en tokens**.

**Quién elige FTMO:** traders priorizando **herencia de marca** y **techo de escala de US$2M**.

**Quién elige FundingPips:** traders que quieren **tres caminos de evaluación** (Zero/1-Step/2-Step) y **flexibilidad de ciclos de recompensa**.

Las tres operan modelos de capital simulado. Las tres tienen historiales legítimos pagando a traders. Elige basado en el encaje del reglamento, no en el marketing.

---

## <a id="pros-cons"></a>Pros y contras

![BrightFunded comparación de pros y contras](../img/brightfunded-pros-cons.png)
...
**NEW15** para nuevos clientes (15% OFF primera compra). **BF10** para clientes existentes (10% OFF cualquier compra).

### ¿Qué es drawdown fijo y por qué importa?

**Drawdown fijo** significa que tu max loss se calcula desde tu **saldo inicial**, no desde el **peak equity**. En la mayoría de las firmas, si estás con +5% y usan trailing drawdown, el piso de tu max-loss sube con las ganancias. El piso de BrightFunded permanece fijo en el saldo inicial menos 10%, lo que da más espacio psicológico y técnico para operar.

### ¿Qué es la recompensa del 15% sobre ganancias de evaluación?

BrightFunded te paga el **15% de tus ganancias de fases de evaluación en efectivo** en tu primer payout de fase fondeada. Si hiciste +US$10K en Fase 1 y +US$5K en Fase 2, cobras un extra de **US$2.250** sobre tu primer payout fondeado.
...
**1:100 en forex majors**, 1:50 en crosses y metales, 1:20 en índices, 1:2 en CFDs de cripto.

### ¿Puedo usar EAs en BrightFunded?

Sí, los expert advisors están permitidos en MT5 y cTrader. Aplican restricciones estándar (sin exploits HFT, sin copy trading entre múltiples cuentas, sin latency arbitrage).

### ¿Qué tan rápido paga BrightFunded?

**Procesamiento de payout garantizado en 24 horas**. Primer payout fondeado elegible 7 días tras tu primera operación fondeada. Los payouts en USDC llegan a la wallet instantáneamente; transferencias bancarias dentro de 24 horas del procesamiento.

### ¿BrightFunded tiene regla de consistencia?

**Sin regla de consistencia en la evaluación.** Algunos límites soft estilo consistencia aplican en la fase fondeada (estándar en la industria), pero nada tan agresivo como el "mejor día < 50% del total" de FTMO en el desafío.

### ¿Puedo operar futuros en BrightFunded?

**No.** BrightFunded es solo forex + índices + commodities + CFDs de cripto. Para futuros (ES, NQ, CL), usa **Apex**, **Bulenox**, **TPT** o **Earn2Trade**.
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Article",
      "headline": "BrightFunded Review 2026: Drawdown Fijo, 100% Split, Tokens Trade2Earn",
      "description": "Review completa BrightFunded: drawdown fijo del 10%, profit split hasta 100%, escala hasta US$400K, programa de fidelidad Trade2Earn en tokens, MT5/cTrader/DXtrade. Cupones NEW15 / BF10 hasta 15% OFF.",
      ...
      "inLanguage": "es",
      "mainEntityOfPage": "https://www.marketscoupons.com/es/guides/brightfunded-review"
    },
    {
      "@type": "Review",
      ...
      "author": { "@type": "Organization", "name": "Markets Coupons" },
      "inLanguage": "es",
      "reviewBody": "BrightFunded es una Prop Firm forex con sede en Dubái (fundada en 2022) con drawdown fijo, recompensa del 15% sobre ganancia de evaluación, fidelidad en tokens Trade2Earn, profit split de hasta 100%, escala hasta US$400K y más de US$13M en payouts a traders. Plataformas: MT5, cTrader, DXtrade. Cupones NEW15 (15%) / BF10 (10%)."
    },
    {
      "@type": "FAQPage",
      "inLanguage": "es",
      "mainEntity": [
        { "@type": "Question", "name": "¿Es BrightFunded confiable?", "acceptedAnswer": { "@type": "Answer", "text": "Firma registrada en Dubái operando desde 2022 con más de 30 empleados, 3 oficinas y más de US$13M en payouts totales a traders. Empieza con un tamaño pequeño de cuenta para validar." } },
        { "@type": "Question", "name": "¿Cuál es el cupón de BrightFunded?", "acceptedAnswer": { "@type": "Answer", "text": "NEW15 para nuevos clientes (15% OFF primera compra). BF10 para clientes existentes (10% OFF cualquier compra)." } },
        { "@type": "Question", "name": "¿Qué es drawdown fijo?", "acceptedAnswer": { "@type": "Answer", "text": "Max loss se calcula desde el saldo inicial, no desde peak equity. En una cuenta de US$100K, tu hard stop permanece en US$90K incluso tras ganancias." } },
        { "@type": "Question", "name": "¿Qué es la recompensa del 15% sobre ganancias de evaluación?", "acceptedAnswer": { "@type": "Answer", "text": "BrightFunded paga el 15% de tus ganancias de fases de evaluación en efectivo en tu primer payout de fase fondeada." } },
        { "@type": "Question", "name": "¿Cuánto apalancamiento ofrece BrightFunded?", "acceptedAnswer": { "@type": "Answer", "text": "1:100 en forex majors, 1:50 en crosses y metales, 1:20 en índices, 1:2 en CFDs de cripto." } }
      ]
    },
    {
      "@type": "HowTo",
      "name": "Cómo pasar la evaluación 2-Step de BrightFunded",
      "inLanguage": "es",
      "step": [
        { "@type": "HowToStep", "name": "Elige el tamaño de cuenta", "text": "Elige US$5K, US$10K, US$25K, US$50K, US$100K o US$200K de capital inicial." },
        { "@type": "HowToStep", "name": "Aplica NEW15", "text": "Escribe NEW15 en checkout para 15% OFF en tu primera compra." },
        { "@type": "HowToStep", "name": "Instala la plataforma", "text": "Instala MT5, cTrader o DXtrade e inicia sesión con las credenciales de BrightFunded." },
        { "@type": "HowToStep", "name": "Respeta el drawdown fijo", "text": "Mantente dentro del 5% max daily loss y 10% max total loss, ambos fijos desde el saldo inicial." },
        { "@type": "HowToStep", "name": "Alcanza la meta de Fase 1 (10%)", "text": "Alcanza +10% de meta de ganancia en un mínimo de 5 días hábiles de trading en Fase 1." },
        { "@type": "HowToStep", "name": "Alcanza la meta de Fase 2 (5%)", "text": "Alcanza +5% de meta de ganancia en un mínimo de 5 días hábiles de trading en Fase 2." },
        { "@type": "HowToStep", "name": "Recibe la recompensa del 15% de evaluación", "text": "En tu primer payout de cuenta fondeada, reclama el 15% de tus ganancias de fase de evaluación como bonus en efectivo." },
        { "@type": "HowToStep", "name": "Escala hacia US$400K", "text": "Opera rentablemente, acumula tokens, escala en tiers de 25% hacia el techo de US$400K." }
      ]
    }
  ]
}
