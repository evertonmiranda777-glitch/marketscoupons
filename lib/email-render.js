...
const INST_TEMPLATES = {
  ...
  'ultimas-horas': {
    color: '#DC2626',
    subject: { pt:'Ultimas horas — desconto vai acabar', en:'Last hours — discount ending soon', es:'Ultimas horas — el descuento termina pronto', fr:'Dernieres heures — la promo se termine', de:'Letzte Stunden — Rabatt endet bald', it:'Ultime ore — lo sconto sta per finire', ar:'الساعات الأخيرة — الخصم ينتهي قريباً' },
    preheader: { pt:'Apex 90% off e Bulenox 89% off voltam ao preço cheio em breve. Sem prorrogação.', en:'Apex 90% off and Bulenox 89% off going back to full price soon. No extensions.', es:'Apex 90% off y Bulenox 89% off vuelven al precio normal pronto.', fr:'Apex 90% off et Bulenox 89% off reviennent au prix plein bientôt.', de:'Apex 90% off und Bulenox 89% off bald wieder zum vollen Preis.', it:'Apex 90% off e Bulenox 89% off tornano al prezzo pieno presto.', ar:'خصم Apex 90% وBulenox 89% سيعودان للسعر الكامل قريباً.' },
    title: { pt:'O desconto esta acabando', en:'The discount is ending', es:'El descuento se termina', fr:'La promo touche a sa fin', de:'Der Rabatt endet bald', it:'Lo sconto sta per finire', ar:'الخصم على وشك الانتهاء' },
    body: {
      pt:'As melhores ofertas não duram pra sempre. Essas promoções estão nas <b>últimas horas</b> — depois disso, volta pro preço cheio. Se você já estava pensando, agora é a hora.',
      en:'The best deals don\'t last forever. These promos are in their <b>final hours</b> — after that, back to full price. If you\'ve been thinking about it, now is the time.',
      es:'Las mejores ofertas no duran para siempre. Estas promociones estan en sus <b>ultimas horas</b> — despues vuelven al precio normal.',
      fr:'Les meilleures offres ne durent pas eternellement. Ces promos sont dans leurs <b>dernieres heures</b>.',
      de:'Die besten Angebote halten nicht ewig. Diese Aktionen sind in ihren <b>letzten Stunden</b>.',
      it:'Le migliori offerte non durano per sempre. Queste promo sono nelle <b>ultime ore</b>.',
      ar:'أفضل العروض لا تدوم للأبد. هذه العروض في <b>ساعاتها الأخيرة</b>.',
    },
    features: {
      pt:['Apex Trader Funding — 90% OFF Lifetime (cupom MARKET)','Bulenox — 89% OFF Lifetime (cupom MARKET89)','Desconto aplicado automaticamente no checkout','Valido por tempo limitado — sem prorrogacao'],
      en:['Apex Trader Funding — 90% OFF Lifetime (coupon MARKET)','Bulenox — 89% OFF Lifetime (coupon MARKET89)','Discount applied automatically at checkout','Valid for limited time — no extensions'],
      es:['Apex Trader Funding — 90% OFF Lifetime (cupon MARKET)','Bulenox — 89% OFF Lifetime (cupon MARKET89)','Descuento aplicado automaticamente','Valido por tiempo limitado'],
      fr:['Apex Trader Funding — 90% OFF Lifetime (coupon MARKET)','Bulenox — 89% OFF Lifetime (coupon MARKET89)','Reduction appliquee automatiquement','Valable pour une duree limitee'],
      de:['Apex Trader Funding — 90% OFF Lifetime (Gutschein MARKET)','Bulenox — 89% OFF Lifetime (Gutschein MARKET89)','Rabatt automatisch an der Kasse','Nur fur begrenzte Zeit'],
      it:['Apex Trader Funding — 90% OFF Lifetime (coupon MARKET)','Bulenox — 89% OFF Lifetime (coupon MARKET89)','Sconto applicato automaticamente','Valido per tempo limitato'],
      ar:['Apex Trader Funding — 90% OFF Lifetime (كوبون MARKET)','Bulenox — 89% OFF Lifetime (كوبون MARKET89)','الخصم يُطبق تلقائياً','صالح لفترة محدودة'],
    },
    cta: { pt:'APROVEITAR AGORA', en:'GET IT NOW', es:'APROVECHAR AHORA', fr:'EN PROFITER', de:'JETZT SICHERN', it:'APPROFITTA ORA', ar:'احصل عليه الآن' },
  },
