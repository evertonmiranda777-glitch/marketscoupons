...
const INST_TEMPLATES = {
  welcome: {
    ...
    body: {
      pt:'MarketsCoupons reúne <b>18+ Prop Firms com cupons exclusivos, até 90% de economia na sua avaliação</b>. Plus: Análise Diária às 6h, Comparador lado a lado, Calendário Econômico e Calculadora de Position Size, tudo num só lugar.',
      en:'MarketsCoupons gathers <b>18+ Prop Firms with exclusive coupons, up to 90% off your evaluation</b>. Plus: Daily Analysis at 6 AM ET, side-by-side Comparator, Economic Calendar and Position Size Calculator.',
      es:'MarketsCoupons reúne <b>18+ Prop Firms con cupones exclusivos, hasta 90% de descuento</b>. Plus: Análisis Diario a las 6 AM, Comparador lado a lado, Calendario Económico y Calculadora.',
      fr:'MarketsCoupons réunit <b>18+ Prop Firms avec coupons exclusifs, jusqu\'à 90% de réduction</b>. Plus : Analyse Quotidienne à 6h, Comparateur, Calendrier Économique et Calculateur.',
      de:'MarketsCoupons versammelt <b>18+ Prop Firms mit exklusiven Gutscheinen, bis zu 90% Rabatt</b>. Plus: Tagesanalyse um 6 Uhr, Side-by-Side-Vergleich, Wirtschaftskalender und Rechner.',
      it:'MarketsCoupons raccoglie <b>18+ Prop Firms con coupon esclusivi, fino al 90% di sconto</b>. Plus: Analisi Quotidiana alle 6, Comparatore, Calendario Economico e Calcolatore.',
      ar:'MarketsCoupons يجمع <b>18+ Prop Firms مع كوبونات حصرية, خصم يصل إلى 90%</b>. بالإضافة إلى: التحليل اليومي والمقارن والتقويم الاقتصادي وحاسبة حجم المركز.',
    },
    features: {
      pt:['18+ Prop Firms com cupons exclusivos negociados direto com as firmas','Comparador lado a lado com Trustpilot real (rating + reviews)','Análise Diária às 6h dos 4 ativos (S&P 500, Nasdaq, Ouro, Petróleo)','Calculadora de Position Size + Calendário Econômico + Heatmap','Programa de Fidelidade: 1 compra desbloqueia 3 ferramentas premium'],
      en:['18+ Prop Firms with exclusive coupons negotiated directly with firms','Side-by-side Comparator with real Trustpilot (rating + reviews)','Daily Analysis at 6 AM ET on 4 assets (S&P 500, Nasdaq, Gold, Oil)','Position Size Calculator + Economic Calendar + Heatmap','Loyalty Program: 1 purchase unlocks 3 premium tools'],
      es:['18+ Prop Firms con cupones exclusivos','Comparador lado a lado con Trustpilot real','Análisis Diario a las 6 AM (S&P 500, Nasdaq, Oro, Petróleo)','Calculadora de Position Size + Calendario + Heatmap','Programa de Fidelidad: 1 compra desbloquea 3 herramientas'],
      fr:['18+ Prop Firms avec coupons exclusifs','Comparateur côte à côte avec Trustpilot réel','Analyse Quotidienne à 6h sur 4 actifs','Calculateur de Position Size + Calendrier + Heatmap','Programme de Fidélité : 1 achat débloque 3 outils'],
      de:['18+ Prop Firms mit exklusiven Gutscheinen','Side-by-Side-Vergleich mit echtem Trustpilot','Tagesanalyse um 6 Uhr auf 4 Assets','Position-Size-Rechner + Wirtschaftskalender + Heatmap','Treueprogramm: 1 Kauf schaltet 3 Premium-Tools frei'],
      it:['18+ Prop Firms con coupon esclusivi','Comparatore affiancato con Trustpilot reale','Analisi Quotidiana alle 6 su 4 asset','Calcolatore Position Size + Calendario + Heatmap','Programma Fedeltà: 1 acquisto sblocca 3 strumenti'],
      ar:['18+ Prop Firms مع كوبونات حصرية','مقارن جنباً إلى جنب مع Trustpilot حقيقي','التحليل اليومي الساعة 6 صباحاً على 4 أصول','حاسبة حجم المركز + التقويم الاقتصادي + خريطة حرارية','برنامج الولاء: عملية شراء واحدة تفتح 3 أدوات بريميوم'],
    },
    ...
    highlight: {
      ...
      sub: { pt:'Cupom <b>{{CUP:bulenox}}</b>, 89% OFF · copie no site e use no checkout', en:'Coupon <b>{{CUP:bulenox}}</b>, 89% OFF · copy on the site, paste at checkout', es:'Cupón <b>{{CUP:bulenox}}</b>, 89% OFF · cópialo y úsalo en el checkout', fr:'Coupon <b>{{CUP:bulenox}}</b>, 89% OFF · à copier et coller au checkout', de:'Gutschein <b>{{CUP:bulenox}}</b>, 89% OFF · kopieren und beim Checkout einfügen', it:'Coupon <b>{{CUP:bulenox}}</b>, 89% OFF · copia e incolla al checkout', ar:'كوبون <b>{{CUP:bulenox}}</b>, 89% OFF · انسخه واستخدمه عند الدفع' },
    },
  },
  'site-invite': {
    color: '#FF6F00',
    ...
    preheader: { pt:'Apex 90% off, Bulenox 89% off. Copie no site e use no checkout. Sem cadastro de cartão.', en:'Apex 90% off, Bulenox 89% off. Copy on the site, paste at checkout. No credit card required.', es:'Apex 90% off, Bulenox 89% off. Cópialo y úsalo en el checkout. Sin tarjeta.', fr:'Apex 90% off, Bulenox 89% off. À copier et coller au checkout. Sans carte bancaire.', de:'Apex 90% off, Bulenox 89% off. Kopieren und beim Checkout einfügen.', it:'Apex 90% off, Bulenox 89% off. Copia e incolla al checkout.', ar:'Apex 90% خصم، Bulenox 89% خصم. انسخه واستخدمه عند الدفع.' },
    ...
    body: {
      pt:'Reunimos cupons exclusivos negociados direto com as firmas, até 90% de desconto na sua avaliação. <b>Tudo verificado e atualizado diariamente. Copie no site e cole no checkout da firma.</b>',
      en:'We gather exclusive coupons negotiated directly with firms, up to 90% off your evaluation. <b>All verified and updated daily. Copy on the site and paste at the firm checkout.</b>',
      es:'Reunimos cupones exclusivos negociados directamente con las firmas, hasta 90% de descuento. <b>Todo verificado y actualizado diariamente. Cópialo en el sitio y pégalo en el checkout.</b>',
      fr:'On réunit des coupons exclusifs négociés directement avec les firmes, jusqu\'à 90% de réduction. <b>Tout vérifié et mis à jour quotidiennement. Copiez sur le site et collez au checkout.</b>',
      de:'Wir sammeln exklusive Gutscheine direkt mit den Firmen verhandelt, bis zu 90% Rabatt. <b>Alles verifiziert und täglich aktualisiert. Auf der Seite kopieren und beim Checkout einfügen.</b>',
      it:'Raccogliamo coupon esclusivi negoziati direttamente con le firme, fino al 90% di sconto. <b>Tutto verificato e aggiornato quotidianamente. Copia dal sito e incolla al checkout.</b>',
      ar:'نجمع كوبونات حصرية تم التفاوض عليها مباشرة مع الشركات, خصم يصل إلى 90% على تقييمك. <b>كل شيء موثق ومحدث يومياً. انسخ من الموقع والصق عند الدفع.</b>',
    },
    features: {
      pt:['18+ Prop Firms com cupons exclusivos','Comparador lado a lado com Trustpilot real','Análise diária às 6h, ES, NQ, Ouro, Petróleo','Heatmap, Calendário Econômico e Calculadoras','Blog educacional do iniciante ao avançado'],
      en:['18+ Prop Firms with exclusive coupons','Side-by-side comparator with real Trustpilot','Daily analysis at 6AM, ES, NQ, Gold, Oil','Heatmap, Economic Calendar and Calculators','Educational blog from beginner to advanced'],
      es:['18+ Prop Firms con cupones exclusivos','Comparador lado a lado con Trustpilot real','Análisis diario a las 6h, ES, NQ, Oro, Petróleo','Heatmap, Calendario Económico y Calculadoras','Blog educacional del principiante al avanzado'],
      fr:['18+ Prop Firms avec coupons exclusifs','Comparateur côte à côte avec Trustpilot réel','Analyse quotidienne à 6h, ES, NQ, Or, Pétrole','Heatmap, Calendrier Économique et Calculatrices','Blog éducatif du débutant à l\'avancé'],
      de:['18+ Prop Firms mit exklusiven Gutscheinen','Vergleich nebeneinander mit echtem Trustpilot','Tägliche Analyse um 6 Uhr, ES, NQ, Gold, Öl','Heatmap, Wirtschaftskalender und Rechner','Bildungsblog vom Anfänger bis Fortgeschritten'],
      it:['18+ Prop Firms con coupon esclusivi','Comparatore affiancato con Trustpilot reale','Analisi giornaliera alle 6, ES, NQ, Oro, Petrolio','Heatmap, Calendario Economico e Calcolatrici','Blog educativo dal principiante all\'avanzato'],
      ar:['18+ شركة Prop Firm مع كوبونات حصرية','مقارنة جنباً إلى جنب مع Trustpilot حقيقي','تحليل يومي الساعة 6, ES, NQ, ذهب, نفط','خريطة حرارية, تقويم اقتصادي وحاسبات','مدونة تعليمية من المبتدئ إلى المتقدم'],
    },
  ...
  indicators: {
    ...
    features: {
      pt:['Comparador lado a lado: 18+ Prop Firms com Trustpilot real','Calculadora de Position Size: cálculo automático por % de risco','Calendário Econômico: filtro por impacto, hora local, alertas 5min antes','Heatmap: SPX500, Nasdaq, Forex, Crypto, ETFs','Membros Fidelidade: + Análise Diária às 6h, Mapa GEX, Live Room VIP'],
      en:['Side-by-side Comparator: 18+ Prop Firms with real Trustpilot','Position Size Calculator: auto-math by % risk','Economic Calendar: filter by impact, local time, 5-min alerts','Heatmap: SPX500, Nasdaq, Forex, Crypto, ETFs','Loyalty Members: + Daily Analysis at 6 AM, GEX Map, VIP Live Room'],
      es:['Comparador lado a lado: 18+ Prop Firms con Trustpilot real','Calculadora de Position Size: cálculo automático por % de riesgo','Calendario Económico: filtro por impacto, hora local','Heatmap: SPX500, Nasdaq, Forex, Crypto, ETFs','Miembros Fidelidad: + Análisis Diario, Mapa GEX, Live Room VIP'],
      ...
      de:['Side-by-Side-Vergleich: 18+ Prop Firms mit echtem Trustpilot','Position-Size-Rechner: automatische Berechnung','Wirtschaftskalender: Filter nach Impact, lokale Zeit','Heatmap: SPX500, Nasdaq, Forex, Crypto, ETFs','Treuemitglieder: + Tagesanalyse, GEX-Karte, VIP Live Room'],
      it:['Comparatore affiancato: 18+ Prop Firms con Trustpilot reale','Calcolatore Position Size: calcolo automatico per % di rischio','Calendario Economico: filtro per impatto, ora locale','Heatmap: SPX500, Nasdaq, Forex, Crypto, ETFs','Membri Fedeltà: + Analisi Quotidiana, Mappa GEX, Live Room VIP'],
      ar:['مقارن جنباً إلى جنب: 18+ Prop Firms مع Trustpilot حقيقي','حاسبة حجم المركز: حساب تلقائي بـ% المخاطرة','التقويم الاقتصادي: فلتر حسب التأثير، التوقيت المحلي','خريطة حرارية: SPX500, Nasdaq, Forex, Crypto, ETFs','أعضاء الولاء: + التحليل اليومي، خريطة GEX، Live Room VIP'],
    },
  ...
  'ultimas-horas': (() => {
    ...
    const pre  = 'Use coupons {{CUP:apex}} and {{CUP:bulenox}} at checkout. After today, full price returns. No extensions.';
  ...
  'top3': {
    kind: 'top3-cards',
    color: '#F0B429',
    subject: { pt:'A maioria vai abrir este email tarde demais.', en:'Most people will open this email too late.', es:'La mayoría abrirá este email demasiado tarde.', fr:'La plupart ouvriront cet email trop tard.', de:'Die meisten öffnen diese E-Mail zu spät.', it:'La maggior parte aprirà questa email troppo tardi.', ar:'معظمهم سيفتح هذه الرسالة بعد فوات الأوان.' },
    preheader: { pt:'Apex 100K $39,90 · Bulenox $23,65 · TradeDay 100K $142. Cupom no site.', en:'Apex 100K $39.90 · Bulenox $23.65 · TradeDay 100K $142. Coupon on the site.', es:'Apex 100K $39,90 · Bulenox $23,65 · TradeDay 100K $142. Cupón en el sitio.', fr:'Apex 100K $39,90 · Bulenox $23,65 · TradeDay 100K $142. Coupon sur le site.', de:'Apex 100K $39,90 · Bulenox $23,65 · TradeDay 100K $142. Gutschein auf der Seite.', it:'Apex 100K $39,90 · Bulenox $23,65 · TradeDay 100K $142. Coupon sul sito.', ar:'Apex 100K $39.90 · Bulenox $23.65 · TradeDay 100K $142. الكوبون على الموقع.' },
    hero_pill: { pt:'Você está pagando 10× a mais?', en:'Are you paying 10× more?', es:'¿Estás pagando 10× más?', fr:'Vous payez 10× plus ?', de:'Zahlst du 10× mehr?', it:'Stai pagando 10× di più?', ar:'هل تدفع 10× أكثر؟' },
    hero_h1: { pt:'Pare de pagar preço cheio<br>nas 3 melhores firmas', en:'Stop paying full price<br>at the 3 best firms', es:'Deja de pagar precio completo<br>en las 3 mejores firmas', fr:'Arrêtez de payer plein tarif<br>chez les 3 meilleures firmes', de:'Hör auf, Vollpreis zu zahlen<br>bei den 3 besten Firmen', it:'Smetti di pagare prezzo pieno<br>nelle 3 migliori firme', ar:'توقف عن دفع السعر الكامل<br>في أفضل 3 شركات' },
    hero_sub: { pt:'Comprando as 3 contas 100K agora você economiza <b style="color:#10B981">$760</b> com esses cupons.', en:'Buying the 3 100K accounts now you save <b style="color:#10B981">$760</b> with these coupons.', es:'Comprando las 3 cuentas 100K ahora ahorras <b style="color:#10B981">$760</b> con estos cupones.', fr:'En achetant les 3 comptes 100K maintenant vous économisez <b style="color:#10B981">$760</b>.', de:'Mit dem Kauf der 3 100K Konten sparst du jetzt <b style="color:#10B981">$760</b>.', it:'Comprando i 3 conti 100K ora risparmi <b style="color:#10B981">$760</b>.', ar:'بشراء حسابات 100K الثلاثة الآن توفر <b style="color:#10B981">$760</b>.' },
    firms: [
      { id:'apex',    name:'Apex Trader Funding · 100K', accent:'#F0B429', off:'90', price_full:'$399', price_disc:'$39,90', savings:'$359,10', coupon:'{{CUP:apex}}' },
      { id:'bulenox', name:'Bulenox · 100K',             accent:'#0891B2', off:'89', price_full:'$215', price_disc:'$23,65', savings:'$191,35', coupon:'{{CUP:bulenox}}' },
      { id:'tradeday', name:'TradeDay · 100K',           accent:'#F59E0B', off:'50', price_full:'$285', price_disc:'$142,00', savings:'$143,00', coupon:'{{CUP:tradeday}}' },
    ],
    savings_label: { pt:'Economia: ', en:'Save: ', es:'Ahorras: ', fr:'Économie : ', de:'Ersparnis: ', it:'Risparmio: ', ar:'وفر: ' },
    coupon_label:  { pt:'cupom', en:'coupon', es:'cupón', fr:'coupon', de:'Gutschein', it:'coupon', ar:'كوبون' },
    total_label:   { pt:'Economia total comprando as 3', en:'Total savings buying all 3', es:'Ahorro total comprando las 3', fr:'Économie totale pour les 3', de:'Gesamtersparnis bei allen 3', it:'Risparmio totale per le 3', ar:'إجمالي التوفير لشراء الثلاثة' },
    total_value:   '$760,45',
    total_sub:     { pt:'De <s>$994</s> por apenas <b>$233,55</b>', en:'From <s>$994</s> for only <b>$233.55</b>', es:'De <s>$994</s> por solo <b>$233,55</b>', fr:'De <s>$994</s> pour seulement <b>$233,55</b>', de:'Statt <s>$994</s> nur <b>$233,55</b>', it:'Da <s>$994</s> a soli <b>$233,55</b>', ar:'من <s>$994</s> بسعر <b>$233.55</b> فقط' },
    cta:           { pt:'PEGAR OS 3 CUPONS AGORA →', en:'GET THE 3 COUPONS NOW →', es:'CONSIGUE LOS 3 CUPONES YA →', fr:'PRENDRE LES 3 COUPONS →', de:'JETZT 3 GUTSCHEINE HOLEN →', it:'PRENDI I 3 COUPON ORA →', ar:'احصل على الكوبونات الثلاثة الآن →' },
    cta_url:       'https://www.marketscoupons.com/coupons?utm_source=email&utm_medium=campaign&utm_campaign=top3&s={SUB}',
    disclaimer:    { pt:'Copie o cupom no site e cole no checkout da firma · Sem cadastro pra ver os preços', en:'Copy the coupon on the site and paste at the firm checkout · No signup to see prices', es:'Copia el cupón en el sitio y pégalo en el checkout · Sin registro para ver los precios', fr:'Copiez le coupon sur le site et collez-le au checkout · Sans inscription pour voir les prix', de:'Kopiere den Gutschein auf der Seite und füge ihn beim Checkout ein · Keine Registrierung', it:'Copia il coupon dal sito e incollalo al checkout · Senza registrazione per vedere i prezzi', ar:'انسخ الكوبون من الموقع والصق عند الدفع · بدون تسجيل لرؤية الأسعار' },
  },
...
/* Links de afiliado dos e-mails: FONTE UNICA = tabela `firms`.
   Nunca voltar a escrever URL literal aqui (o link da Aqua ficou meses morto assim).
   Mantem o sufixo de campanha keyword=email pra atribuicao por canal. */
let _affCache = { at: 0, map: {} };
let _affSync = {};   // mapa slug->url ja resolvido (preenchido por primeAff())
let _cupSync = {};   // mapa slug->cupom (null = firma sem codigo)
async function _affUrls() {
  if (Date.now() - _affCache.at < 300000 && Object.keys(_affCache.map).length) return _affCache.map;
  try {
    const base = process.env.SUPABASE_URL, key = process.env.SUPABASE_ANON_KEY || process.env.SUPABASE_SERVICE_ROLE_KEY;
    if (!base || !key) return _affCache.map;
    const r = await fetch(`${base}/rest/v1/firms?select=slug,affiliate_url,coupon_code&ativo=eq.true`, { headers: { apikey: key, Authorization: `Bearer ${key}` } });
    if (!r.ok) return _affCache.map;
    const m = {}, c = {};
    (await r.json()).forEach((x) => {
      let u = x.affiliate_url || '', hash = '';
      const i = u.indexOf('#'); if (i >= 0) { hash = u.slice(i); u = u.slice(0, i); }
      m[x.slug] = u + (u.includes('?') ? '&' : '?') + 'keyword=email' + hash;
      c[x.slug] = x.coupon_code;   // null = firma sem codigo
    });
    _cupSync = c;
    _affCache = { at: Date.now(), map: m };
    _affSync = m;
  } catch (_) {}
...
function buildUrgentDealHtml(t, lang, unsubUrl) {
  const _a = (typeof _affSync !== 'undefined' && _affSync) || {};
  const AFF_APEX = _a.apex || '', AFF_BULENOX = _a.bulenox || '';
  const ano = new Date().getFullYear();
  const apexDeadline = t.apexDeadline || '2026-05-08T03:59:00Z';
  // email-image endpoint deletado 2026-05-25 (Vercel function limit). Templates "últimas horas"
  // não estão sendo enviados; campanha desativada. countdownUrl mantida como placeholder
  // pra não quebrar template em uso esporádico (img vai dar broken-image, aceitável).
  const countdownUrl = `https://www.marketscoupons.com/img/pwa/icon-192.png`;
  return `<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0">
<meta name="color-scheme" content="only light"><meta name="supported-color-schemes" content="only light">
...
<div style="display:none;max-height:0;overflow:hidden;font-size:1px;color:#f4f5f7;opacity:0;">Apex 90% off and Bulenox 89% off. Coupons {{CUP:apex}} and {{CUP:bulenox}}. Final hours.</div>
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f4f5f7;padding:24px 0;"><tr><td align="center">
<table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background:#fff;border-radius:14px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,.08);">
  <tr><td style="padding:28px 32px 20px;text-align:center;">
  ...
  <tr><td style="padding:32px 36px 8px;text-align:left;">
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#fff;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;margin-bottom:24px;">
      <tr><td style="background:#F97316;padding:16px 22px;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
        ...
        <td align="right" style="vertical-align:middle;"><div style="display:inline-block;padding:7px 13px;background:#0d141c;border-radius:6px;font-family:'Courier New',monospace;font-size:14px;font-weight:800;color:#F97316;letter-spacing:1.5px;">{{CUP:apex}}</div></td>
      </tr></table></td></tr>
      ...
      <tr><td style="padding:8px 22px 18px;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
        ...
        <tr><td colspan="4" style="padding:14px 0;"><a href="${AFF_APEX}" style="display:block;text-decoration:none;background:#fff7ed;border-radius:10px;box-shadow:inset 0 0 0 2px #F97316;position:relative;">
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:18px;"><tr><td align="center"><a href="${AFF_APEX}" style="display:inline-block;padding:13px 32px;background:#F97316;color:#fff;font-size:14px;font-weight:800;text-decoration:none;border-radius:8px;letter-spacing:.2px;">Get Apex with {{CUP:apex}} coupon &rarr;</a></td></tr></table>
      <p style="margin:10px 0 0;font-size:11px;color:#9ca3af;line-height:1.5;text-align:center;">Use the coupon code <strong style="color:#374151;">{{CUP:apex}}</strong> at checkout to apply the 90% discount.</p>
      </td></tr>
    </table>
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#fff;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;margin-bottom:24px;">
      <tr><td style="background:#3B82F6;padding:16px 22px;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
        ...
        <td align="right" style="vertical-align:middle;"><div style="display:inline-block;padding:7px 13px;background:#0d141c;border-radius:6px;font-family:'Courier New',monospace;font-size:14px;font-weight:800;color:#60A5FA;letter-spacing:1.5px;">{{CUP:bulenox}}</div></td>
      </tr></table></td></tr>
      <tr><td style="padding:8px 22px 18px;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
        ...
        <tr><td colspan="4" style="padding:14px 0;"><a href="${AFF_BULENOX}" style="display:block;text-decoration:none;background:#eff6ff;border-radius:10px;box-shadow:inset 0 0 0 2px #3B82F6;position:relative;">
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:18px;"><tr><td align="center"><a href="${AFF_BULENOX}" style="display:inline-block;padding:13px 32px;background:#3B82F6;color:#fff;font-size:14px;font-weight:800;text-decoration:none;border-radius:8px;letter-spacing:.2px;">Get Bulenox with {{CUP:bulenox}} &rarr;</a></td></tr></table>
      <p style="margin:10px 0 0;font-size:11px;color:#9ca3af;line-height:1.5;text-align:center;">Use the coupon code <strong style="color:#374151;">{{CUP:bulenox}}</strong> at checkout to apply the 89% discount.</p>
      </td></tr>
    </table>
...
function buildTop3CardsHtml(t, lang, unsubUrl) {
  const ano = new Date().getFullYear();
  const C = t.color;
  const SAV = pick(t.savings_label, lang);
  const CPN = pick(t.coupon_label, lang);

  // Nomes curtos pra caber em mobile sem quebrar
  const SHORT_NAMES = { apex:'Apex · 100K', bulenox:'Bulenox · 100K', tradeday:'TradeDay · 100K' };
  const cardsHtml = t.firms.map(f => {
    const shortName = SHORT_NAMES[f.id] || f.name;
    return `
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:12px;background:#fafafa;border:1px solid #e5e7eb;border-left:4px solid ${f.accent};border-radius:10px;"><tr>
      <td width="60" valign="middle" style="padding:14px 0 14px 14px;width:60px;">
        <img src="https://www.marketscoupons.com/img/Firms/${f.id}.png" alt="" width="44" height="44" style="display:block;background:#0a0d14;border-radius:8px;border:0;">
      </td>
      <td valign="middle" style="padding:14px 14px 14px 12px;">
        <div style="font-size:15px;font-weight:800;color:#111;letter-spacing:-.2px;line-height:1.2;">${shortName}</div>
        <div style="margin-top:5px;font-size:13px;color:#374151;line-height:1.3;">
          <span style="color:#9ca3af;text-decoration:line-through;">${f.price_full}</span>
          &rarr;
          <strong style="color:${f.accent};font-size:15px;">${f.price_disc}</strong>
          <strong style="color:#DC2626;margin-left:4px;">&minus;${f.off}%</strong>
        </div>
        <div style="margin-top:4px;font-size:11px;color:#10B981;font-weight:700;">${SAV}${f.savings} · ${CPN} <span style="font-family:Courier,monospace;letter-spacing:.5px;">${f.coupon}</span></div>
      </td>
    </tr></table>`;
  }).join('');
...
<meta name="color-scheme" content="only light"><meta name="supported-color-schemes" content="only light">
<title>Markets Coupons</title>
<style>:root{color-scheme:light only;}html,body{margin:0!important;padding:0!important;background-color:#f4f5f7!important;}@media (prefers-color-scheme:dark){html,body{background-color:#f4f5f7!important;color:#111!important;}}</style>
</head><body style="margin:0;padding:0;background:#f4f5f7;font-family:Inter,-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif;color:#111;">
<div style="display:none;max-height:0;overflow:hidden;font-size:1px;color:#f4f5f7;opacity:0;">${pick(t.preheader, lang)}</div>
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f4f5f7;padding:24px 0;"><tr><td align="center">
<table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background:#fff;border-radius:14px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,.08);">

  <tr><td style="padding:28px 32px 20px;text-align:center;">
    <span style="font-size:22px;font-weight:800;color:#1a1a1a;">Markets <span style="color:${C};">Coupons</span></span>
    <div style="margin-top:8px;font-size:11px;color:#6b7480;letter-spacing:1.4px;text-transform:uppercase;font-weight:700;">${pick({pt:'Top 3 cupons hoje',en:'Top 3 coupons today',es:'Top 3 cupones hoy',fr:'Top 3 coupons aujourd\'hui',de:'Top 3 Gutscheine heute',it:'Top 3 coupon oggi',ar:'أفضل 3 كوبونات اليوم'}, lang)}</div>
  </td></tr>

  <tr><td style="height:3px;background:linear-gradient(90deg,transparent,#DC2626,transparent);"></td></tr>

  <tr><td style="background:#000;padding:44px 32px 38px;text-align:center;">
    <div style="display:inline-block;padding:6px 16px;background:rgba(220,38,38,.14);border:1px solid rgba(220,38,38,.4);border-radius:99px;font-size:11px;font-weight:800;letter-spacing:2px;color:#fca5a5;text-transform:uppercase;margin-bottom:18px;">${pick(t.hero_pill, lang)}</div>
    <h1 style="margin:0 0 14px;font-size:28px;font-weight:900;line-height:1.15;color:#fff;letter-spacing:-.7px;">${pick(t.hero_h1, lang)}</h1>
    <p style="margin:0;font-size:14px;color:#b8c5d6;line-height:1.6;max-width:440px;margin-left:auto;margin-right:auto;">${pick(t.hero_sub, lang)}</p>
  </td></tr>
  ...
  <tr><td style="padding:32px 32px 8px;">
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#ecfdf5;border:1px solid #10B981;border-radius:12px;margin:18px 0 24px;"><tr><td style="padding:18px 20px;text-align:center;">
      <div style="font-size:11px;font-weight:800;color:#10B981;letter-spacing:1.5px;text-transform:uppercase;margin-bottom:6px;">${pick(t.total_label, lang)}</div>
      <div style="font-size:32px;font-weight:900;color:#10B981;letter-spacing:-1px;line-height:1;">${t.total_value}</div>
      <div style="margin-top:6px;font-size:12px;color:#3a3f4a;">${pick(t.total_sub, lang)}</div>
    </td></tr></table>

    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:18px;"><tr><td align="center">
      <a href="${t.cta_url}" style="display:inline-block;padding:16px 40px;background:linear-gradient(135deg,#c8941a,${C},#f5d060,${C},#c8941a);color:#0d141c;font-size:15px;font-weight:800;text-decoration:none;border-radius:50px;letter-spacing:.3px;box-shadow:0 8px 24px rgba(240,180,41,.3);">${pick(t.cta, lang)}</a>
    </td></tr></table>

    <p style="margin:0 0 28px;font-size:12px;color:#9ca3af;text-align:center;line-height:1.6;">${pick(t.disclaimer, lang)}</p>
  </td></tr>

  <tr><td style="padding:0 32px;"><div style="border-top:1px solid #e5e7eb;"></div></td></tr>
  <tr><td style="padding:22px 32px 26px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0"><tr>
    <td style="vertical-align:middle;padding-right:14px;"><div style="width:44px;height:44px;border-radius:50%;background:linear-gradient(135deg,${C},#ff8c00);text-align:center;line-height:44px;font-size:17px;font-weight:800;color:#fff;">L</div></td>
    <td style="vertical-align:middle;"><div style="font-size:14px;font-weight:700;color:#111;">Lara</div><div style="font-size:12px;color:#6b7480;">${pick({pt:'Equipe Markets Coupons',en:'Markets Coupons Team',es:'Equipo Markets Coupons',fr:'Équipe Markets Coupons',de:'Markets Coupons Team',it:'Team Markets Coupons',ar:'فريق Markets Coupons'}, lang)}</div></td>
  </tr></table></td></tr>

  <tr><td style="background:#fafafa;padding:22px 32px;text-align:center;border-top:1px solid #e5e7eb;">
    <p style="margin:0 0 8px;font-size:11px;color:#9ca3af;line-height:1.6;">${pick(FOOTER_TEXT, lang)}</p>
    <p style="margin:8px 0 0;font-size:11px;color:#9ca3af;">&copy; ${ano} Markets Coupons</p>
    <p style="margin:10px 0 0;font-size:10px;color:#b9c0c9;"><a href="${unsubUrl||'https://www.marketscoupons.com/'}" style="color:#9ca3af;text-decoration:underline;">${pick(UNSUB_TEXT, lang)}</a></p>
  </td></tr>
...
function renderInstHtml(name, lang, unsubUrl) {
  return resolveCupons(_renderInstHtmlRaw(name, lang, unsubUrl));
}
function _renderInstHtmlRaw(name, lang, unsubUrl) {
  ...
  if (t.kind === 'top3-cards') return buildTop3CardsHtml(t, lang, unsubUrl);
  const C = t.color;
...
function getSubject(name, lang) {
  return resolveCupons(pick(INST_TEMPLATES[name]?.subject, lang) || '');
}

/* ── {{CUP:slug}} ────────────────────────────────────────────────────────────
   Mesmo token ja usado em api/bot.js e nos .md dos guias. Cupom literal em
   template de e-mail e o pior caso da familia: dispara pra lista inteira de
   uma vez, e nao da pra "regerar" um e-mail que ja saiu.
   Firma sem codigo resolve pra string vazia, nunca pro cupom de outra firma. */
function resolveCupons(html) {
  if (html == null) return html;   // preserva o null de "template nao existe"
  return String(html).replace(/\{\{CUP:([a-z0-9-]+)\}\}/g, (full, slug) => {
    const c = _cupSync[slug];
    return c == null ? '' : c;
  });
}

/* primeAff(): carrega os links de afiliado da tabela `firms` ANTES de renderizar.
   Quem chama renderInstHtml deve dar await primeAff() (senao o link do email sai vazio). */
async function primeAff(){ await _affUrls(); return _affSync; }
module.exports = { renderInstHtml, getSubject, INST_TEMPLATES, primeAff };
