...
const INST_TEMPLATES = {
  ...
  'top3': {
    ...
    firms: [
      ...
      { id:'apex',    name:'Apex 100K · Pack 5 contas',                    accent:'#F0B429', off:'90', price_full:'$1.750', price_disc:'$175,00', savings:'$1.575,00', coupon:'MARKET' },
      { id:'apex',    name:'Apex 100K · Sem Taxa de Ativação',             accent:'#F0B429', off:'73', price_full:'$399',  price_disc:'$109,00', savings:'$290,00',  coupon:'MARKET' },
      { id:'apex',    name:'Apex 100K · Pack 5 contas Sem Taxa Ativação',  accent:'#F0B429', off:'72', price_full:'$1.750', price_disc:'$495,00', savings:'$1.255,00', coupon:'MARKET' },
  ...
  <tr><td style="padding:32px 36px 8px;text-align:left;">
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#fff;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;margin-bottom:24px;">
      ...
      <tr><td style="padding:8px 22px 18px;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
        ...
        <tr><td colspan="4" style="padding:14px 0;"><a href="https://apextraderfunding.com/member/aff/go/evertonmiranda?keyword=email#block_660bfb7d9cd2c41901144ab4319f8644" style="display:block;text-decoration:none;background:#fff7ed;border-radius:10px;box-shadow:inset 0 0 0 2px #F97316;position:relative;">
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:18px;"><tr><td align="center"><a href="https://apextraderfunding.com/member/aff/go/evertonmiranda?keyword=email#block_660bfb7d9cd2c41901144ab4319f8644" style="display:inline-block;padding:13px 32px;background:#F97316;color:#fff;font-size:14px;font-weight:800;text-decoration:none;border-radius:8px;letter-spacing:.2px;">Get Apex with MARKET coupon &rarr;</a></td></tr></table>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#fff;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;margin-bottom:24px;">
      ...
      <tr><td style="padding:8px 22px 18px;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
        ...
        <tr><td colspan="4" style="padding:14px 0;"><a href="https://bulenox.com/member/aff/go/marketcoupons?keyword=email" style="display:block;text-decoration:none;background:#eff6ff;border-radius:10px;box-shadow:inset 0 0 0 2px #3B82F6;position:relative;">
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:18px;"><tr><td align="center"><a href="https://bulenox.com/member/aff/go/marketcoupons?keyword=email" style="display:inline-block;padding:13px 32px;background:#3B82F6;color:#fff;font-size:14px;font-weight:800;text-decoration:none;border-radius:8px;letter-spacing:.2px;">Get Bulenox with MARKET89 &rarr;</a></td></tr></table>
