...
const INST_TEMPLATES = {
  ...
  'top3': {
    ...
    hero_sub: { pt:'Comprando as 3 contas 100K agora você economiza <b style="color:#10B981">$1.230</b> com esses cupons.', en:'Buying the 3 100K accounts now you save <b style="color:#10B981">$1,230</b> with these coupons.', es:'Comprando las 3 cuentas 100K ahora ahorras <b style="color:#10B981">$1.230</b> con estos cupones.', fr:'En achetant les 3 comptes 100K maintenant vous économisez <b style="color:#10B981">$1.230</b>.', de:'Mit dem Kauf der 3 100K Konten sparst du jetzt <b style="color:#10B981">$1.230</b>.', it:'Comprando i 3 conti 100K ora risparmi <b style="color:#10B981">$1.230</b>.', ar:'بشراء حسابات 100K الثلاثة الآن توفر <b style="color:#10B981">$1,230</b>.' },
    firms: [
      ...
      { id:'tpt',     name:'TakeProfit · 100K',          accent:'#A855F7', off:'50', price_full:'$169', price_disc:'$84,50', savings:'$84,50',  coupon:'MARKET40' },
    ],
    ...
    total_value:   '$679,95',
    total_sub:     { pt:'De <s>$833</s> por apenas <b>$153,05</b>', en:'From <s>$833</s> for only <b>$153.05</b>', es:'De <s>$833</s> por solo <b>$153,05</b>', fr:'De <s>$833</s> pour seulement <b>$153,05</b>', de:'Statt <s>$833</s> nur <b>$153,05</b>', it:'Da <s>$833</s> a soli <b>$153,05</b>', ar:'من <s>$833</s> بسعر <b>$153.05</b> فقط' },
