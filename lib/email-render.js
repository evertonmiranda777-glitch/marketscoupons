...
const INST_TEMPLATES = {
  welcome: {
    ...
    highlight: {
      ...
      sub: { pt:'Cupom <b>MARKET89</b>, 89% OFF · copie no site e use no checkout', en:'Coupon <b>MARKET89</b>, 89% OFF · copy on the site, paste at checkout', es:'Cupón <b>MARKET89</b>, 89% OFF · cópialo y úsalo en el checkout', fr:'Coupon <b>MARKET89</b>, 89% OFF · à copier et coller au checkout', de:'Gutschein <b>MARKET89</b>, 89% OFF · kopieren und beim Checkout einfügen', it:'Coupon <b>MARKET89</b>, 89% OFF · copia e incolla al checkout', ar:'كوبون <b>MARKET89</b>, 89% OFF · انسخه واستخدمه عند الدفع' },
    },
  },
  'site-invite': {
    color: '#FF6F00',
  ...
  'top3': {
    ...
    firms: [
      { id:'apex',    name:'Apex Trader Funding · 100K', accent:'#F0B429', off:'90', price_full:'$399', price_disc:'$39,90', savings:'$359,10', coupon:'MARKET' },
      { id:'bulenox', name:'Bulenox · 100K',             accent:'#0891B2', off:'89', price_full:'$215', price_disc:'$23,65', savings:'$191,35', coupon:'MARKET89' },
      { id:'tradeday', name:'TradeDay · 100K',           accent:'#F59E0B', off:'50', price_full:'$285', price_disc:'$142,00', savings:'$143,00', coupon:'MARKETS' },
    ],
...
async function _affUrls() {
  ...
  try {
    ...
    const r = await fetch(`${base}/rest/v1/firms?select=slug,affiliate_url&ativo=eq.true`, { headers: { apikey: key, Authorization: `Bearer ${key}` } });
...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background:#fff;border-radius:14px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,.08);">
  ...
  <tr><td style="padding:32px 36px 8px;text-align:left;">
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#fff;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;margin-bottom:24px;">
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:18px;"><tr><td align="center"><a href="${AFF_APEX}" style="display:inline-block;padding:13px 32px;background:#F97316;color:#fff;font-size:14px;font-weight:800;text-decoration:none;border-radius:8px;letter-spacing:.2px;">Get Apex with MARKET coupon &rarr;</a></td></tr></table>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#fff;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;margin-bottom:24px;">
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:18px;"><tr><td align="center"><a href="${AFF_BULENOX}" style="display:inline-block;padding:13px 32px;background:#3B82F6;color:#fff;font-size:14px;font-weight:800;text-decoration:none;border-radius:8px;letter-spacing:.2px;">Get Bulenox with MARKET89 &rarr;</a></td></tr></table>
