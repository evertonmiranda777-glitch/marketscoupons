...
(function(){
  ...
  var css='#mc-site-ft{background:rgba(3,5,7,.85);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border-top:1px solid rgba(255,255,255,.18);padding:48px 24px 28px;position:relative;color:#C4CCD2;font-family:Inter,system-ui,sans-serif;'+(RTL?'direction:rtl;':'')+'}'+
    ...
    '#mc-site-ft .ft-logo em{color:#BFFF00;font-style:normal}'+
    ...
    '#mc-site-ft .ft-nl-desc{font-size:12px;color:#C4CCD2;margin-bottom:8px;line-height:1.5}'+
    '#mc-site-ft .ft-nl-form{display:flex;gap:6px}'+
    '#mc-site-ft .ft-nl-form input{flex:1;min-width:0;padding:8px 12px;background:rgba(11,15,12,.78);border:1px solid rgba(255,255,255,.22);border-radius:7px;color:#fff;font-size:12px;font-family:inherit;outline:none}'+
    '#mc-site-ft .ft-nl-form button{padding:8px 16px;background:#BFFF00;color:#070A06;border:none;border-radius:7px;font-size:11px;font-weight:700;cursor:pointer;font-family:inherit;white-space:nowrap}'+
    '#mc-site-ft .ft-soc{display:flex;gap:10px;margin-top:16px}'+
    '#mc-site-ft .ft-s{display:inline-flex;align-items:center;justify-content:center;width:38px;height:38px;border-radius:10px;border:1px solid rgba(255,255,255,.18);background:rgba(255,255,255,.08);color:#C4CCD2;transition:.3s;cursor:pointer;text-decoration:none}'+
    ...
    '#mc-site-ft .ft-h{font-size:14px;font-weight:700;color:#BFFF00;margin:0 0 14px;letter-spacing:.3px;text-transform:uppercase}'+
    '#mc-site-ft .fc-col a{display:block;font-size:12px;color:#C4CCD2;margin-bottom:9px;transition:color .2s;cursor:pointer;text-decoration:none}'+
    '#mc-site-ft .fc-col a:hover{color:#fff}'+
    '#mc-site-ft .ft-bot{padding-top:20px;border-top:1px solid rgba(255,255,255,.18);font-size:12px;color:rgba(255,255,255,.25);line-height:1.7}'+
    ...
    '#mc-site-ft .ft-links a:hover{color:#C4CCD2}'+
    '#mc-site-ft .ft-disclaimers{margin-top:32px;padding-top:24px;border-top:1px solid rgba(255,255,255,.18);font-size:12px;line-height:1.7;color:#8A94A0}'+
    '#mc-site-ft .ft-disclaimers strong{color:#C4CCD2;font-size:12px}'+
  ...
  var logoSvg='<img src="/img/fox-lime.jpg" width="28" height="28" alt="" style="object-fit:contain;flex-shrink:0">';
