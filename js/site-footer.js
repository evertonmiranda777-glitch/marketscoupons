...
(function(){
  ...
  var html='<footer id="mc-site-ft"><div class="ft-in"><div class="ft-grid">'+
    ...
    '<div class="ft-disclaimers"><div><strong>'+esc(t('risk_t'))+'</strong><p>'+esc(t('risk'))+'</p></div></div>'+
    '</div></footer>';
