...
FUNDED FUTURES FAMILY / FFF (Futures), coupon MARKET. 90% split (first $10K is 100%). Platforms: WealthCharts, Tradovate. Key differentiators: NO activation fee (funded account free after passing), no Daily Loss Limit on Prime, funded account available next day, payout guaranteed in 24h (avg ~2h), up to 5 sim-funded accounts (or 1 live). Discounts with MARKET vary by plan: Velocity 80% off, Premier Plus & Prime 40% off (first 5 uses, then 30%), S2F has NO active discount right now. Most eval plans are MONTHLY subscriptions (recurring during the eval) except S2F which is one-time. 4 plan families (min days differ, be exact):
