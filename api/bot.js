...
- NO ACTIVATION FEE, EVER (any size): FundedNext · Funded Futures Family (FFF) · TradeDay · Aqua Futures · Blueberry Futures · Futures Elite · Goat Funded Futures (EOD) · E8 Markets (Signature). If a trader is comparing on total cost, lead with these.
- CHARGES AN ACTIVATION FEE: Bulenox - one-time Master Account activation, no monthly fee after: 25K $143, 50K $148, 100K $248, 150K $498, 250K $898. Top One Futures - $19 activation (Elite Daily / Elite Access). Earn2Trade - $139 one-time, but charged ONLY on your first successful payout, never upfront. Apex - Standard accounts pay a PA activation fee after passing; the "No Activation Fee" variant costs more upfront but includes it (see Apex pricing above).
- NOT PUBLISHED / CHECK BEFORE PROMISING: Alpha Futures, Blue Guardian, City Traders Imperium, FundingPips, BrightFunded, FTMO, The5ers. If asked, say you would rather confirm than guess, and point them to the firm's checkout - never invent a number.

APEX (Futures), coupon MARKET, 90% OFF LIFETIME. Split 100% up to $25K then 90%. Trailing DD. Target 8%. Min 1 day, eval 30 days. 4 pricing dimensions: Type (Intraday Trail vs EOD Trail) × Size (25K/50K/100K/150K) × Variant (Standard with activation fee vs No Activation Fee) × Pack (1 account vs 5-pack). Platforms: Rithmic, Tradovate, NinjaTrader, WealthCharts. Intraday Standard 1-pack with coupon: 25K $19.90 (was $199), 50K $24.90 ($249), 100K $39.90 ($399), 150K $59.90 ($599). EOD Standard 1-pack with coupon: 25K $39 (was $390), 50K $49 ($490), 100K $79 ($790), 150K $149 ($1490). EOD Standard 5-pack with coupon: 25K $175 ($35/account, was $1750), 50K $225 ($45/acct, $2250), 100K $345 ($69/acct, $3450), 150K $695 ($139/acct, $6950). Intraday No-Activation 1-pack: 25K $69 ($690), 50K $79 ($790), 100K $109 ($1090), 150K $169 ($1690). EOD No-Activation 1-pack: 25K $89 ($890), 50K $109 ($1090), 100K $159 ($1590), 150K $249 ($2490). In the No Activation Fee variant, 100K and 150K are single-plan only (no 5-Pack option). 5-pack discounts available (e.g. Intraday Std 5-pack 100K $175 = $35/account). Perks: no daily loss limit, payout in 5 days, up to 20 accounts, news trading ok, day-1 payout, no recurring fees, no scaling rules, no consistency rule. Trustpilot 4.3 (19.4k).
