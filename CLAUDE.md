...
4. **Telegram** `telegram-creative` SCHEDULE+COUPONS (deploy CLI). 5. **Compare pages** (build + regex vercel). 6. **Push dropdown** (dinâmico já). 7. **Back criativo** `img/<id>-bg.png` **E** `.webp` + FIRM_WORDMARK (criativo-render + admin).
