...
function mcBuildKeyword(firmId){
  ...
  return String(raw).toLowerCase().replace(/[^a-z0-9_\-]/g,'_').slice(0,40) || 'mcsite';
}
function mcInjectKeyword(url, firmId){
  const kw = mcBuildKeyword(firmId);
  if (!kw) return url;
...
const FIRM_BG={
  ...
  e8:'img/e8-bg.jpeg',cti:'img/cti-bg.jpeg',tradeday:'img/tradeday-bg.png'
};
const FIRM_ABOUT={
  apex:{about:'Fundada em <b>2021</b> por Darrell Martin em Austin, Texas. A Apex é a <b>6ª prop firm mais buscada do mundo</b> com 4.2M de visitas mensais. Taxa de aprovação de <b>15-20%</b> — 2x a média do setor.',highlights:[{val:'$721M+',label:'Pagos a traders'},{val:'$85M+',label:'Últimos 90 dias'},{val:'100%',label:'Do lucro (2026)'}],
    types:['Intraday Trail','EOD Trail'],plans:{'Intraday Trail':[{s:'25K',d:'$99.50',o:'$199'},{s:'50K',d:'$124.50',o:'$249'},{s:'100K',d:'$199.50',o:'$399',pop:1},{s:'150K',d:'$299.50',o:'$599'}],'EOD Trail':[{s:'25K',d:'$149.50',o:'$299'},{s:'50K',d:'$174.50',o:'$349'},{s:'100K',d:'$299.50',o:'$599',pop:1},{s:'150K',d:'$399.50',o:'$799'}]},
  ...
  e2t:{about:'Fundada em <b>2016</b>, celebrando <b>10 anos</b> em 2026. Foco em educação e desenvolvimento. Taxa de aprovação de <b>10.42%</b> — acima da média do setor. Escalamento até $400K.',highlights:[{val:'10 anos',label:'No mercado'},{val:'$400K',label:'Scaling máximo'},{val:'10.4%',label:'Taxa aprovação'}],
    types:['Trader Career Path','Gauntlet Mini'],plans:{'Trader Career Path':[{s:'TCP25',d:'$75',o:'$150'},{s:'TCP50',d:'$95',o:'$190'},{s:'TCP100',d:'$175',o:'$350',pop:1}],'Gauntlet Mini':[{s:'50K',d:'$85',o:'$170'},{s:'100K',d:'$157.50',o:'$315',pop:1},{s:'150K',d:'$187.50',o:'$375'},{s:'200K',d:'$275',o:'$550'}]},
  ...
  brightfunded:{about:'Fundada em <b>2022</b> na Holanda por Jelle Dijkstra. <b>27.5K+ traders</b>. Programa Trade2Earn (pontos por operar). Payout em <b>24h</b> com ciclo de 7 dias.',highlights:[{val:'$13M+',label:'Pagos a traders'},{val:'27.5K+',label:'Traders'},{val:'24h',label:'Payout garantido'}],
    types:['2-Step'],plans:{'2-Step':[{s:'5K',d:'€46.75',o:'€55'},{s:'10K',d:'€80.75',o:'€95'},{s:'25K',d:'€165.75',o:'€195'},{s:'50K',d:'€250.75',o:'€295',pop:1},{s:'100K',d:'€420.75',o:'€495'},{s:'200K',d:'€828.75',o:'€975'}]},
  ...
  tradeday:{about:'Fundada em <b>Chicago, Illinois</b>. A TradeDay opera <b>apenas futuros</b> nas exchanges CME, CBOT, NYMEX e COMEX. Destaque pelo <b>Day 1 Payout</b>, <b>sem regra de consistência</b> e split progressivo até <b>95%</b>. Taxa de aprovação de <b>28.2%</b> (Out 2023 – Mar 2024) — acima da média do setor.',highlights:[{val:'Dia 1',label:'Primeiro saque'},{val:'95%',label:'Split máximo'},{val:'28.2%',label:'Taxa aprovação'}],
    types:['Intraday','EOD','Static'],plans:{'Intraday':[{s:'50K',d:'$87',o:'$125'},{s:'100K',d:'$140',o:'$200',pop:1},{s:'150K',d:'$210',o:'$300'}],'EOD':[{s:'50K',d:'$122',o:'$175'},{s:'100K',d:'$192',o:'$275',pop:1},{s:'150K',d:'$262',o:'$375'}],'Static':[{s:'50K',d:'$115',o:'$165'},{s:'100K',d:'$175',o:'$250',pop:1},{s:'150K',d:'$245',o:'$350'}]},
...
async function openGuideArticle(slug){
  ...
  art.innerHTML=`
    ...
    <div class="guide-art-cta">
      ...
      <div class="guide-art-cta-desc">${t('guia_cta_desc')||'Compare as melhores prop firms com cupons exclusivos de até 50% de desconto.'}</div>
...
<tbody>
<tr><td>Apex</td><td>$50K Rithmic</td><td>$167/mês</td><td>~$17-33 (80-50% OFF)</td></tr>
...
<ul>
<li><strong>Futuros:</strong> Apex $50K — sem prazo para completar, drawdown end-of-day, promoções frequentes de 80-50% OFF</li>
...
function renderAwards(){
  ...
  const categories=[
    ...
    {trophy:_asvg('<polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/>','#22c55e'),catKey:'aw_cat_maior_desconto',firmId:'apex',reasonKey:'aw_reason_apex_desconto',value:'50% OFF',ribbonKey:'aw_ribbon_desconto'},
...
const FAQ_LANGS = {
  pt: [
    ...
    {q:'Qual a melhor prop firm para iniciantes?', a:'Depende do seu perfil. A Apex Trader Funding oferece até 50% de desconto e regras flexíveis. A Bulenox permite passar em 1 dia. A FTMO tem Free Trial ilimitado. Use nosso Quiz para descobrir a melhor para você.'},
  ...
  en: [
    ...
    {q:'What is the best prop firm for beginners?', a:'It depends on your profile. Apex Trader Funding offers up to 50% off and flexible rules. Bulenox lets you pass in 1 day. FTMO has an unlimited Free Trial. Use our Quiz to find the best one for you.'},
  ...
  es: [
    ...
    {q:'¿Cuál es la mejor prop firm para principiantes?', a:'Apex ofrece hasta 50% de descuento. Bulenox permite pasar en 1 día. FTMO tiene Free Trial ilimitado. Usa nuestro Quiz para encontrar la mejor para ti.'},
  ...
  it: [
    ...
    {q:'Qual è la migliore prop firm per i principianti?', a:'Apex offre fino al 50% di sconto. Bulenox permette di superare la valutazione in 1 giorno. FTMO ha un Free Trial illimitato. Usa il nostro Quiz per trovare quella giusta per te.'},
  ...
  fr: [
    ...
    {q:'Quelle est la meilleure prop firm pour les débutants ?', a:'Apex offre jusqu\'à 50% de réduction. Bulenox permet de réussir en 1 jour. FTMO a un Free Trial illimité. Utilisez notre Quiz pour trouver la meilleure pour vous.'},
  ...
  de: [
    ...
    {q:'Was ist die beste Prop Firm für Anfänger?', a:'Apex bietet bis zu 50% Rabatt. Bulenox ermöglicht das Bestehen in 1 Tag. FTMO hat eine unbegrenzte Free Trial. Nutze unser Quiz, um die Beste für dich zu finden.'},
  ...
  ar: [
    ...
    {q:'ما هي أفضل Prop Firm للمبتدئين؟', a:'Apex تقدم خصماً حتى 50%. Bulenox يتيح الاجتياز في يوم واحد. FTMO لديها تجربة مجانية غير محدودة. استخدم اختبارنا للعثور على الأفضل لك.'},
...
async function loadFirmsFromSupabase() {
  try {
    ...
    if (error || !data || !data.length) {
      ...
      const cached = localStorage.getItem('mc_firms_cache_v2');
    ...
    try { localStorage.setItem('mc_firms_cache_v2', JSON.stringify(FIRMS)); } catch(e){}
...
function qfinish(){
  setTimeout(()=>{
    ...
    if(!rec)rec=FIRMS[0];
    if(!rec)return;
    document.getElementById('q-res-content').innerHTML=`<div class="qr-title">${t('quiz_resultado_firma_ideal')} <span style="display:inline-flex;align-items:center;gap:8px;vertical-align:middle;color:${rec.color};">${firmIco(rec,'28px','11px')} ${rec.name}</span></div><div class="qr-desc">${(I18N[_currentLang]?.['firm_desc_'+rec.id]||I18N.pt['firm_desc_'+rec.id]||rec.desc||'')}</div><div style="display:flex;gap:12px;justify-content:center;margin-top:8px;width:100%;max-width:360px;margin-left:auto;margin-right:auto;"><a href="${mcInjectKeyword(rec.link,rec.id)}" target="_blank" style="text-decoration:none;display:flex;flex:1;"><button class="btn-gold" style="width:100%;white-space:nowrap;">${t('quiz_comecar_agora')}</button></a><button class="q-restart" style="flex:1;white-space:nowrap;" onclick="qreset()">${t('quiz_recomecar')}</button></div>`;
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try{ localStorage.removeItem('mc_firms_cache'); }catch(e){}
  // Preload FIRMS from localStorage cache BEFORE sync boot (avoids empty-state flash on /firm-slug refresh)
  if(FIRMS.length===0){
    try{ const cached=localStorage.getItem('mc_firms_cache_v2'); if(cached){ const arr=JSON.parse(cached); arr.forEach(f=>FIRMS.push(f)); } }catch(e){}
  }
