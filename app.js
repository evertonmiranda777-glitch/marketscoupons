...
const FIRM_ABOUT={
  ...
  bulenox:{about:'Fundada em <b>2022</b>. Crescimento de <b>500%</b> em tráfego ano a ano. Regras simplificadas — possível passar em <b>1 dia</b>, sem regra de consistência.',highlights:[{val:'90%',label:'Profit Split'},{val:'1 dia',label:'Para passar'},{val:'$0',label:'Taxa mensal'}],
    types:['Trailing DD','EOD DD'],plans:{'Trailing DD':[{s:'25K',d:'$15.95',o:'$145'},{s:'50K',d:'$19.25',o:'$175',pop:1},{s:'100K',d:'$23.65',o:'$215'},{s:'150K',d:'$35.75',o:'$325'},{s:'250K',d:'$58.85',o:'$535'}],'EOD DD':[{s:'25K',d:'$15.95',o:'$145'},{s:'50K',d:'$19.25',o:'$175',pop:1},{s:'100K',d:'$23.65',o:'$215'},{s:'150K',d:'$35.75',o:'$325'},{s:'250K',d:'$58.85',o:'$535'}]},
...
const CHECKOUT_FIRMS=[
  ...
  {id:'fundingpips',name:'Funding Pips',short:'FundingPips',coupon:'HELLO',discount:'20%',color:'#6366F1',bg:'rgba(99,102,241,0.12)',
   ...
   buildUrl:(size,type,plat)=>'https://app.fundingpips.com/register?ref=HELLO'},
...
async function loadFirmsFromSupabase() {
  try {
    ...
    if (error || !data || !data.length) {
      ...
      const cached = localStorage.getItem('mc_firms_cache_v4');
    ...
    try { localStorage.setItem('mc_firms_cache_v4', JSON.stringify(FIRMS)); } catch(e){}
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if(FIRMS.length===0){
    try{ const cached=localStorage.getItem('mc_firms_cache_v4'); if(cached){ const arr=JSON.parse(cached); arr.forEach(f=>FIRMS.push(f)); } }catch(e){}
  }
