...
(function () {try {
    ...
    window.fetch = function (...a) {var _a$;const u = typeof a[0] === 'string' ? a[0] : ((_a$ = a[0]) === null || _a$ === void 0 ? void 0 : _a$.url) || '';capture(u);return of.apply(this, a);};
...
function mcOpenFirm(firmId, finalUrl, coupon, firmName) {
  ...
  const _safeErr = (e) => {try {return String((e === null || e === void 0 ? void 0 : e.message) || e || '').slice(0, 200);} catch {return 'unknown';}};
  ...
  try {
    ...
    try {
      ...
      if (ds && f !== null && f !== void 0 && f.discount) ds.textContent = `${f.discount}% OFF`;else
...
function track(event, params = {}) {
  ...
  if (_ga4Event) {var _user$user_metadata;
    ...
    window.dataLayer.push({
      ...
      user_data: {
        external_id: (_user === null || _user === void 0 ? void 0 : _user.id) || _anonId || null,
        em: params.em || (_user === null || _user === void 0 ? void 0 : _user.email) || null,
        ph: params.ph || null,
        fn: params.fn || (_user === null || _user === void 0 || (_user$user_metadata = _user.user_metadata) === null || _user$user_metadata === void 0 || (_user$user_metadata = _user$user_metadata.full_name) === null || _user$user_metadata === void 0 ? void 0 : _user$user_metadata.split(' ')[0]) || null,
        ln: params.ln || null,
        anon_id: _anonId,
        fbp: _fb.fbp || null,
        fbc: _fb.fbc || null
...
async function _evFlush() {
  ...
  try {
    ...
    if (error) {_evBackoffUntil = Date.now() + _evBackoffMs;_evBackoffMs = Math.min(_evBackoffMs * 2, 600000);_evStash(batch);} else
    {_evBackoffMs = 30000;}
...
async function _trackFlushQueue() {
  ...
  try {
    ...
    if (!error) localStorage.removeItem('mc_track_queue');else
    {_evBackoffUntil = Date.now() + _evBackoffMs;}
...
async function setTrackingUser(user) {var _user$user_metadata2, _user$user_metadata3, _user$user_metadata4, _user$user_metadata5, _user$user_metadata6;
  if (!user || localStorage.getItem('mc-cookies-consent') !== 'accepted') return;
  const email = user.email || '';
  const phone = ((_user$user_metadata2 = user.user_metadata) === null || _user$user_metadata2 === void 0 ? void 0 : _user$user_metadata2.phone) || '';
  const fn = ((_user$user_metadata3 = user.user_metadata) === null || _user$user_metadata3 === void 0 ? void 0 : _user$user_metadata3.full_name) || '';
  ...
  window.dataLayer.push({
    ...
    user_data: {
      ...
      plan: ((_user$user_metadata4 = user.user_metadata) === null || _user$user_metadata4 === void 0 ? void 0 : _user$user_metadata4.plan) || 'free',
      loyalty_tier: ((_user$user_metadata5 = user.user_metadata) === null || _user$user_metadata5 === void 0 ? void 0 : _user$user_metadata5.loyalty_tier) || 'none',
      country: ((_user$user_metadata6 = user.user_metadata) === null || _user$user_metadata6 === void 0 ? void 0 : _user$user_metadata6.country) || _geo && _geo.geo_country || null
    }
  });
}
...
function _sendCAPI(event, params, eid, ts) {
  ...
  try {var _user$user_metadata7, _user$user_metadata8, _user$user_metadata9;
    ...
    const external_id = (user === null || user === void 0 ? void 0 : user.id) || anon_id || '';
    fetch('https://qfwhduvutfumsaxnuofa.supabase.co/functions/v1/facebook-capi', {
      ...
      body: JSON.stringify({
        ...
        events: [{
          ...
          fbp: fbp || '',
          fbc: fbc || '',
          em: params.em || (user === null || user === void 0 ? void 0 : user.email) || _savedEm() || '',
          ph: params.ph || (user === null || user === void 0 || (_user$user_metadata7 = user.user_metadata) === null || _user$user_metadata7 === void 0 ? void 0 : _user$user_metadata7.phone) || _savedPh() || '',
          external_id,
          anon_id: anon_id || '',
          fn: params.fn || (user === null || user === void 0 || (_user$user_metadata8 = user.user_metadata) === null || _user$user_metadata8 === void 0 ? void 0 : _user$user_metadata8.full_name) || '',
          ln: params.ln || '',
          country: (user === null || user === void 0 || (_user$user_metadata9 = user.user_metadata) === null || _user$user_metadata9 === void 0 ? void 0 : _user$user_metadata9.country) || '',
          firm_id: params.firm_id || null,
          firm_name: params.firm_name || null,
          content_name: params.content_name || params.firm_name || params.page_name || null,
          content_category: params.content_category || null,
  ...
  if (f && f.prices && f.prices.length) {
    ...
    if (!match) {
      ...
      if (pn !== null) {
        ...
        if (cands.length === 1) match = cands[0];else
        if (cands.length > 1) {
    ...
    if (match) {
      ...
      let dk,ok,ek = null;
      if (five) {
        if (isEod) {dk = naf ? 'na52' : 'n52';ok = naf ? 'na52o' : 'o52';ek = naf ? 'na52e' : 'e52';} else
        {dk = naf ? 'na5' : 'n5';ok = naf ? 'na5o' : 'o5';ek = naf ? 'na5e' : 'e5';}
      } else {
        if (isEod) {dk = naf ? 'na2' : 'n2';ok = naf ? 'nao2' : 'o2';} else
        {dk = naf ? 'na' : 'n';ok = naf ? 'nao' : 'o';}
      }
      const dv = match[dk];
      if (dv) {d = dv;o = match[ok] || '';each = ek ? match[ek] || '' : '';} else
      if (naf || five) {// combo not offered (e.g. EOD 100K/150K No-Activation 5-pack)
...
const FIRM_ABOUT = {
  apex: { about: 'Founded in <b>2021</b> by Darrell Martin in Austin, Texas. Apex is the <b>6th most searched prop firm worldwide</b> with 4.2M monthly visits. Approval rate of <b>15-20%</b>, 2x the industry average.', highlights: [{ val: '$821M+', label: 'Paid to traders' }, { val: '$97M+', label: 'Last 90 days' }, { val: '100%', label: 'Of profit (2026)' }],
    types: ['Intraday Trail', 'EOD Trail'], plans: { 'Intraday Trail': [{ s: '25K', d: '$16.70', o: '$167' }, { s: '50K', d: '$24.90', o: '$249' }, { s: '100K', d: '$39.90', o: '$399', pop: 1 }, { s: '150K', d: '$59.90', o: '$599' }], 'EOD Trail': [{ s: '25K', d: '$39', o: '$390' }, { s: '50K', d: '$49', o: '$490' }, { s: '100K', d: '$79', o: '$790', pop: 1 }, { s: '150K', d: '$149', o: '$1490' }] },
  ...
  ftmo: { about: 'Founded in <b>2015</b> in Prague, Czech Republic. FTMO is the <b>largest Forex prop firm in the world</b>. Over <b>3.5M clients</b> in 140+ countries. Team of 300+ professionals.', highlights: [{ val: '$500M+', label: 'Paid to traders' }, { val: '3.5M+', label: 'Clients' }, { val: '10 years', label: 'In the market' }],
    ...
    includes: ['Unlimited Free Trial', '90% profit split', '20 languages support', 'Scaling up to $2M', '$500M+ paid', 'No time limit'] },
  ...
  the5ers: { about: 'Founded in <b>2016</b> by Saul Lokier in Raanana, Israel. One of the <b>oldest active prop firms</b>. Scaling up to <b>$4M</b> and profit split up to 100%.', highlights: [{ val: '$43M+', label: 'Paid to traders' }, { val: '30K+', label: 'Payouts made' }, { val: '$4M', label: 'Max scaling' }],
    ...
    includes: ['Scaling up to $4M', 'Profit Split up to 100%', 'Avg 16h payout', 'Leverage 1:30', 'No time limit', 'Advanced dashboard'] },
  fundingpips: { about: 'Founded in <b>2022</b> by Khaled Ayesh in Dubai. <b>2M+ traders</b> worldwide. One of the most popular firms with fast payouts and flexible split up to 100%.', highlights: [{ val: '$210M+', label: 'Paid to traders' }, { val: '2M+', label: 'Traders' }, { val: '127K+', label: 'Verified payouts' }],
    ...
    includes: ['Flexible split up to 100%', '$210M+ paid', 'Leverage 1:100', 'Active Discord community'] },
  brightfunded: { about: 'Founded in <b>2022</b> in the Netherlands by Jelle Dijkstra. <b>27.5K+ traders</b>. Trade2Earn program (points for trading). <b>24h</b> payout with 7-day cycle.', highlights: [{ val: '$13M+', label: 'Paid to traders' }, { val: '27.5K+', label: 'Traders' }, { val: '24h', label: 'Guaranteed payout' }],
    ...
    includes: ['Scaling up to 100% split', 'Static drawdown', '24h payout / 7-day cycle', '15% reward in challenge', 'Trade2Earn', 'Leverage 1:100', '24/7 support'] },
  e8: { about: 'Founded in <b>2021</b> in the USA. E8 Markets offers accounts from <b>$5K to $500K</b> in Forex, Futures and Crypto. Two products: <b>Signature</b> (EOD, 80% split) and <b>E8 One</b> (configurable dynamic drawdown 4-14%, up to 100% split).', highlights: [{ val: '$500K', label: 'Max account' }, { val: '100%', label: 'Max split' }, { val: '3', label: 'Markets' }],
    ...
    includes: ['No activation fee', 'Pass in 1 day', 'Forex, Futures and Crypto', 'Configurable 4-14% drawdown', 'Split up to 100%', 'Accounts up to $500K'] },
...
function go(page, skipPush) {
  ...
  if (page === 'painel' && !isAuthed() && !_authLoaded) {var _authReadyPromise2;(_authReadyPromise2 = _authReadyPromise) === null || _authReadyPromise2 === void 0 || _authReadyPromise2.then(() => {if (!isAuthed()) {if (!currentUser) openAuthModal('login');else showConfirmEmailModal('pending');go('home');}});}
...
function closeMM() {['mm', 'mm-ov', 'hbg'].forEach((id) => {var _document$getElementB;return (_document$getElementB = document.getElementById(id)) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.classList.remove('open');});document.body.style.overflow = '';}
...
function applyTranslations() {
  document.querySelectorAll('[data-i18n]').forEach((el) => {
    ...
    if (el.tagName === 'INPUT' || el.tagName === 'TEXTAREA') el.placeholder = val;else
    if (el.tagName === 'OPTION') el.textContent = val;else
    {
      const svg = el.querySelector('svg');
      if (svg) {el.innerHTML = '';el.appendChild(svg);el.append(val);} else
      el.innerHTML = val;
    }
  });
...
async function setL(lang, flag, code) {var _document$getElementB2;
  ...
  if (_openBlogSlug && _openBlogGroup) {
    db.from('blog_posts').select('slug').eq('article_group', _openBlogGroup).eq('lang', lang).eq('active', true).maybeSingle().then(({ data }) => {
      if (data) openBlogArticle(data.slug);else
  ...
  if (activeFr && (_document$getElementB2 = document.getElementById('drw')) !== null && _document$getElementB2 !== void 0 && _document$getElementB2.classList.contains('open')) openD(activeFr.dataset.id);
...
function setFirmSEO(id) {var _f$trustpilot, _f$prices, _f$trustpilot$reviews, _f$trustpilot$reviews2, _fa$about;
  ...
  document.querySelectorAll('link[rel="alternate"][hreflang]').forEach((link) => {
    ...
    if (hl === 'x-default' || hl === 'pt') link.href = 'https://www.marketscoupons.com/' + id;else
    link.href = 'https://www.marketscoupons.com/' + hl + '/' + id;
  });
  ...
  const schema = {
    ...
    category: 'Prop Firm',
    aggregateRating: { '@type': 'AggregateRating', ratingValue: f.rating, bestRating: 5, worstRating: 1, reviewCount: f.reviews, url: ((_f$trustpilot = f.trustpilot) === null || _f$trustpilot === void 0 ? void 0 : _f$trustpilot.url) || '' },
    offers: { '@type': 'AggregateOffer', priceCurrency: 'USD', lowPrice: minPrice.replace(/[^0-9.]/g, ''), offerCount: ((_f$prices = f.prices) === null || _f$prices === void 0 ? void 0 : _f$prices.length) || 1, availability: 'https://schema.org/InStock' }
  };
  if (hasCoupon) {
  ...
  },
  {
    ...
    a: `Yes. MarketsCoupons negotiates exclusive coupons directly with prop firms${f.trustpilot ? ` and tracks Trustpilot ratings (${f.trustpilot.score}/5 with ${((_f$trustpilot$reviews = f.trustpilot.reviews) === null || _f$trustpilot$reviews === void 0 || (_f$trustpilot$reviews2 = _f$trustpilot$reviews.toLocaleString) === null || _f$trustpilot$reviews2 === void 0 ? void 0 : _f$trustpilot$reviews2.call(_f$trustpilot$reviews)) || f.trustpilot.reviews} reviews)` : ''}. All coupons are verified daily.`
  }];
  ...
  const aboutText = (fa === null || fa === void 0 || (_fa$about = fa.about) === null || _fa$about === void 0 ? void 0 : _fa$about.replace(/<[^>]+>/g, '')) || f.desc || '';
...
async function renderBlog() {
  ...
  if (_blogLangLoaded !== curLang || !_blogPostsDB.length) {
    ...
    if (curLang === 'pt' && !_blogPostsDB.length) {
      _renderBlogCards(g, BLOG_POSTS.map((p) => {var _p$catKey;return {
          slug: p.slug, title: t(p.titleKey), excerpt: t(p.excerptKey),
          level: p.level, category: ((_p$catKey = p.catKey) === null || _p$catKey === void 0 ? void 0 : _p$catKey.replace('blog_cat_', '')) || 'educacao',
...
function closeBlogArticle() {
  ...
  if (blogSec) blogSec.scrollIntoView({ behavior: 'smooth', block: 'start' });else
  window.scrollTo({ top: 0, behavior: 'smooth' });
}
...
function tickPromoTimers() {
  document.querySelectorAll('[data-promo-ends]').forEach((el) => {
    ...
    if (diff <= 0) {var _el$closest;
      const bar = document.getElementById('promo-topbar');
      if (el === bar || (_el$closest = el.closest) !== null && _el$closest !== void 0 && _el$closest.call(el, '#promo-topbar')) {if (bar) {bar.style.display = 'none';bar.innerHTML = '';}} else
...
function renderPromoTopbar() {var _siteSettings2;
  const bar = document.getElementById('promo-topbar');
  if (!bar) return;
  const hideBar = () => {
...
function renderFirms(list) {
  ...
  el.innerHTML = list.map((f) => {var _f$reviews;
    ...
    `<div class="mv" style="color:var(--t2);font-size:12px;font-weight:700;line-height:1.2;">${t('met_via')}</div><div class="ml">${t('met_nocode')}</div>`}</div>
      ...
      <!-- Col 5: Reviews -->
      <div class="fmet"><div class="mv">${tpCount || ((_f$reviews = f.reviews) === null || _f$reviews === void 0 ? void 0 : _f$reviews.toLocaleString()) || '—'}</div><div class="ml">Reviews</div></div>
      <!-- Col 6: Trustpilot -->
...
async function toggleFav(firmId) {
  ...
  if (isFav) {
    ...
    if (error) console.warn('fav delete error:', error.message);else
    track('firm_unfavorite', { firm_id: firmId });
  } else {
    _favs.add(firmId);
    _favCounts[firmId] = (_favCounts[firmId] || 0) + 1;
    const { error } = await db.from('favorites').insert({ user_id: currentUser.id, firm_id: firmId });
    if (error) {console.warn('fav insert error:', error.message);_favs.delete(firmId);_favCounts[firmId] = Math.max(0, (_favCounts[firmId] || 1) - 1);showToast(t('toast_fav_error') || 'Error saving favorite. Try again.');} else
    track('firm_favorite', { firm_id: firmId });
  }
...
function applyF() {var _document$getElementB3, _document$getElementB4, _document$getElementB5, _document$getElementB6, _document$getElementB7, _document$getElementB8, _document$getElementB9, _document$getElementB0, _document$getElementB1;
  ...
  const favOnly = (_document$getElementB3 = document.getElementById('fFavOnly')) === null || _document$getElementB3 === void 0 ? void 0 : _document$getElementB3.checked;
  const fFut = (_document$getElementB4 = document.getElementById('fFut')) === null || _document$getElementB4 === void 0 ? void 0 : _document$getElementB4.checked;
  const fFx = (_document$getElementB5 = document.getElementById('fFx')) === null || _document$getElementB5 === void 0 ? void 0 : _document$getElementB5.checked;
  const dH = (_document$getElementB6 = document.getElementById('dH')) === null || _document$getElementB6 === void 0 ? void 0 : _document$getElementB6.checked;
  const dM = (_document$getElementB7 = document.getElementById('dM')) === null || _document$getElementB7 === void 0 ? void 0 : _document$getElementB7.checked;
  const dL = (_document$getElementB8 = document.getElementById('dL')) === null || _document$getElementB8 === void 0 ? void 0 : _document$getElementB8.checked;
  const fLT = (_document$getElementB9 = document.getElementById('fLT')) === null || _document$getElementB9 === void 0 ? void 0 : _document$getElementB9.checked;
  const fNews = (_document$getElementB0 = document.getElementById('fNews')) === null || _document$getElementB0 === void 0 ? void 0 : _document$getElementB0.checked;
  const fD1 = (_document$getElementB1 = document.getElementById('fD1')) === null || _document$getElementB1 === void 0 ? void 0 : _document$getElementB1.checked;
  ...
  if (sort === 'discount') list.sort((a, b) => b.discount - a.discount);else
  if (sort === 'reviews') list.sort((a, b) => b.reviews - a.reviews);else
...
function _applyOverlayData(id, data) {
  ...
  if (data.about_html || data.detail_plans) {var _FIRM_ABOUT$id, _FIRM_ABOUT$id2, _FIRM_ABOUT$id3, _FIRM_ABOUT$id4, _FIRM_ABOUT$id5;
    const _plansObj = data.detail_plans || ((_FIRM_ABOUT$id = FIRM_ABOUT[id]) === null || _FIRM_ABOUT$id === void 0 ? void 0 : _FIRM_ABOUT$id.plans) || {};
    let _types = Array.isArray(data.detail_types) ? data.detail_types : ((_FIRM_ABOUT$id2 = FIRM_ABOUT[id]) === null || _FIRM_ABOUT$id2 === void 0 ? void 0 : _FIRM_ABOUT$id2.types) || [];
    ...
    FIRM_ABOUT[id] = {
      about: data.about_html || ((_FIRM_ABOUT$id3 = FIRM_ABOUT[id]) === null || _FIRM_ABOUT$id3 === void 0 ? void 0 : _FIRM_ABOUT$id3.about) || '',
      highlights: data.about_highlights || ((_FIRM_ABOUT$id4 = FIRM_ABOUT[id]) === null || _FIRM_ABOUT$id4 === void 0 ? void 0 : _FIRM_ABOUT$id4.highlights) || [],
      types: _types,
      plans: _plansObj,
      includes: Array.isArray(data.detail_includes) ? data.detail_includes : ((_FIRM_ABOUT$id5 = FIRM_ABOUT[id]) === null || _FIRM_ABOUT$id5 === void 0 ? void 0 : _FIRM_ABOUT$id5.includes) || []
    };
  }
}
...
async function openD(id) {
  ...
  if (!_drwState[id]) {var _firstPlans$, _cf$types, _cf$platforms, _f$platforms;
    const firstPlans = (cf === null || cf === void 0 ? void 0 : cf.plans) || [];
    // _drwState usa shape diferente (cf.plans com .size, não .s)
    const popPlan = firstPlans.find((p) => p.pop || p.pop === 1);
    const variant = _abDefaultSizeVariant();
    const defSize = variant === 'B' && popPlan ? popPlan.size : ((_firstPlans$ = firstPlans[0]) === null || _firstPlans$ === void 0 ? void 0 : _firstPlans$.size) || '';
    _drwState[id] = {
      type: (cf === null || cf === void 0 || (_cf$types = cf.types) === null || _cf$types === void 0 ? void 0 : _cf$types[0]) || '',
      plat: (cf === null || cf === void 0 || (_cf$platforms = cf.platforms) === null || _cf$platforms === void 0 ? void 0 : _cf$platforms[0]) || ((_f$platforms = f.platforms) === null || _f$platforms === void 0 ? void 0 : _f$platforms[0]) || '',
      size: defSize
    };
  }
...
function openFD(id, f) {var _f$platforms2, _f$trustpilot2, _f$trustpilot3, _f$trustpilot4;
  _fdCurrent = id;
  const fa = FIRM_ABOUT[id];
  ...
  if (!_fdState[id]) _fdState[id] = { type: firstType, plat: ((_f$platforms2 = f.platforms) === null || _f$platforms2 === void 0 ? void 0 : _f$platforms2[0]) || '', size: _abPickDefaultSize(firstPlans) };
  ...
  const tpS = Math.round(((_f$trustpilot2 = f.trustpilot) === null || _f$trustpilot2 === void 0 ? void 0 : _f$trustpilot2.score) || f.rating);
  const tpUrl = ((_f$trustpilot3 = f.trustpilot) === null || _f$trustpilot3 === void 0 ? void 0 : _f$trustpilot3.url) || '';
  const tpReviews = ((_f$trustpilot4 = f.trustpilot) === null || _f$trustpilot4 === void 0 ? void 0 : _f$trustpilot4.reviews) || f.reviews || 0;
...
function fdRenderRight(id, f) {var _f$platforms3, _fa$includes;
  ...
  // Platform pills
  if ((_f$platforms3 = f.platforms) !== null && _f$platforms3 !== void 0 && _f$platforms3.length) {
  ...
  // Size pills
  if (plans !== null && plans !== void 0 && plans.length) {
  ...
  const plan = (plans === null || plans === void 0 ? void 0 : plans.find((p) => p.s === st.size)) || (plans === null || plans === void 0 ? void 0 : plans[0]);
  if (plan) {
    ...
    if (pp.unavailable) {
      ...
      const cur = ((_match = (pp.d || '').match(/[€$]/)) === null || _match === void 0 ? void 0 : _match[0]) || '$';
...
`;
  ...
  // Includes
  if ((_fa$includes = fa.includes) !== null && _fa$includes !== void 0 && _fa$includes.length) {
...
function fdSel(id, key, val) {
  ...
  if (key === 'type') {
    const fa = FIRM_ABOUT[id];
    const plans = fa === null || fa === void 0 ? void 0 : fa.plans[val];
...
function fdGo(id) {
  ...
  if (cf) {
    ...
    track('checkout_click', { firm_id: id, firm_name: f === null || f === void 0 ? void 0 : f.name, platform: st.plat, type: st.type, account_size: st.size, coupon: (f === null || f === void 0 ? void 0 : f.coupon) || 'parceiro', source: _src, value: _fbVal(f, st.size), currency: 'USD' });
    registerLoyaltyClick(st.size || '', st.plat || '', st.type || '', (f === null || f === void 0 ? void 0 : f.name) || '');
    mcOpenFirm(id, url, f === null || f === void 0 ? void 0 : f.coupon, f === null || f === void 0 ? void 0 : f.name);
  } else {
    // Clipboard automatico removido (era _cpToClip aqui).
    track('checkout_click', { firm_id: id, firm_name: (f === null || f === void 0 ? void 0 : f.name) || '', coupon: (f === null || f === void 0 ? void 0 : f.coupon) || 'parceiro', source: _src, value: _fbVal(f), currency: 'USD' });
    registerLoyaltyClick('', '', '', (f === null || f === void 0 ? void 0 : f.name) || '');
    mcOpenFirm(id, (f === null || f === void 0 ? void 0 : f.link) || '#', f === null || f === void 0 ? void 0 : f.coupon, f === null || f === void 0 ? void 0 : f.name);
  }
}
...
document.addEventListener('keydown', (e) => {var _document$getElementB10;if (e.key === 'Escape' && (_document$getElementB10 = document.getElementById('fd-overlay')) !== null && _document$getElementB10 !== void 0 && _document$getElementB10.classList.contains('show')) closeFD();});
// Handle browser back from pushState /apex → close overlay instantly
window.addEventListener('popstate', () => {var _document$getElementB11, _document$getElementB12;
  ...
  (_document$getElementB11 = document.getElementById('ov')) === null || _document$getElementB11 === void 0 || _document$getElementB11.classList.remove('open');
  (_document$getElementB12 = document.getElementById('drw')) === null || _document$getElementB12 === void 0 || _document$getElementB12.classList.remove('open');
  document.querySelectorAll('.fr').forEach((r) => r.classList.remove('active'));
});

function fdGoCheckout(fId) {
  const cf = CHECKOUT_FIRMS.find((x) => x.id === fId);const f = FIRMS.find((x) => x.id === fId);
  if (!cf || !f) {window.open((f === null || f === void 0 ? void 0 : f.link) || '#', '_blank', 'noopener,noreferrer');return;}
...
function openPD(id) {
  ...
  if (!p || !pd) {window.open((p === null || p === void 0 ? void 0 : p.link) || '#', '_blank', 'noopener,noreferrer');return;}
...
function pdRenderRight(id, p) {var _pd$includes;
  ...
  const sc = (plans === null || plans === void 0 ? void 0 : plans.length) <= 5 ? plans === null || plans === void 0 ? void 0 : plans.length : 3;
  ...
  const plan = (plans === null || plans === void 0 ? void 0 : plans.find((pl) => pl.s === st.size)) || (plans === null || plans === void 0 ? void 0 : plans[0]);
  if (plan) {var _match2;
    const oNum = parseFloat((plan.o || '').replace(/[^0-9.]/g, ''));
    const dNum = parseFloat((plan.d || '').replace(/[^0-9.]/g, ''));
    const cur = ((_match2 = (plan.d || '').match(/[$€]/)) === null || _match2 === void 0 ? void 0 : _match2[0]) || '$';
  ...
  // CTA
  h += `<button class="fd-cta" onclick="pdGo('${id}')">${pdVerb(plan === null || plan === void 0 ? void 0 : plan.s)} ${p.name} &#8594;</button>`;
  ...
  // Includes
  if ((_pd$includes = pd.includes) !== null && _pd$includes !== void 0 && _pd$includes.length) {
...
function pdSel(id, key, val) {
  ...
  if (key === 'type') {
    const pd = PLAT_DETAIL[id];
    const plans = pd === null || pd === void 0 ? void 0 : pd.plans[val];
...
function openPDMobile(id) {var _pd$stats;
  _pdCurrent = id;
  const p = getPlatforms().find((x) => x.id === id);
  const pd = PLAT_DETAIL[id];
  track('platform_detail_open', { platform_id: id, platform_name: (p === null || p === void 0 ? void 0 : p.name) || id, device: 'mobile' });
  if (!p || !pd) {window.open((p === null || p === void 0 ? void 0 : p.link) || '#', '_blank', 'noopener,noreferrer');return;}
  const firstType = pd.types[0];
  const firstPlans = pd.plans[firstType];
  const popPlan = firstPlans.find((pl) => pl.pop) || firstPlans[0];
  ...
  if (p.icon_url) {icoEl.style.cssText = `background:${p.bg};`;icoEl.innerHTML = `<img src="${p.icon_url}" alt="${p.name}" style="width:100%;height:100%;object-fit:cover;">`;} else
  {icoEl.style.cssText = `background:${p.bg};color:${p.color};`;icoEl.textContent = p.icon;}
  ...
  // Stats grid
  if ((_pd$stats = pd.stats) !== null && _pd$stats !== void 0 && _pd$stats.length) {
...
function pdRenderMobile(id, p) {var _pd$includes2;
  if (!p) p = getPlatforms().find((x) => x.id === id);
  ...
  if (plan) {var _match3;
    const oNum = parseFloat((plan.o || '').replace(/[^0-9.]/g, ''));
    const dNum = parseFloat((plan.d || '').replace(/[^0-9.]/g, ''));
    const cur = ((_match3 = (plan.d || '').match(/[$€]/)) === null || _match3 === void 0 ? void 0 : _match3[0]) || '$';
    const save = oNum && dNum && plan.o !== '—' ? (oNum - dNum).toFixed(2) : null;
    h += `<div class="fd-price" style="border-color:${p.color}1F"><div style="position:absolute;top:0;left:0;right:0;height:1px;background:linear-gradient(90deg,transparent,${p.color}40,transparent)"></div>
  ...
  // Includes
  if ((_pd$includes2 = pd.includes) !== null && _pd$includes2 !== void 0 && _pd$includes2.length) {
    h += `<div class="fd-includes"><div class="fd-inc-title">${t('pd_incluso')}</div>
      <div class="fd-inc-grid">${pd.includes.map((i) => `<div class="fd-inc">${tf(i)}</div>`).join('')}</div></div>`;
  }
...
document.addEventListener('keydown', (e) => {var _document$getElementB13;if (e.key === 'Escape' && (_document$getElementB13 = document.getElementById('pd-overlay')) !== null && _document$getElementB13 !== void 0 && _document$getElementB13.classList.contains('show')) closePD();});

// ── MOBILE: Drawer sidebar ──
function openDrw(id, f, cf) {var _f$trustpilot5, _f$trustpilot6, _f$trustpilot7, _f$trustpilot8;
  const icoEl = document.getElementById('d-ico');
  if (f.icon_url) {
  ...
  const bgUrl = FIRM_BG[id];
  const s = strs(f.rating);
  const tpS = Math.round(((_f$trustpilot5 = f.trustpilot) === null || _f$trustpilot5 === void 0 ? void 0 : _f$trustpilot5.score) || f.rating);
  const tpUrl = ((_f$trustpilot6 = f.trustpilot) === null || _f$trustpilot6 === void 0 ? void 0 : _f$trustpilot6.url) || '';
  const tpReviews = ((_f$trustpilot7 = f.trustpilot) === null || _f$trustpilot7 === void 0 ? void 0 : _f$trustpilot7.reviews) || f.reviews || 0;

  // ── Premium layout (same pattern as desktop fd-overlay) ──
  if (fa) {
    if (!_fdState[id]) {var _f$platforms4;
      const firstType = fa.types[0];const firstPlans = fa.plans[firstType];
      // A/B test default size (variante A = menor / B = popular)
      _fdState[id] = { type: firstType, plat: ((_f$platforms4 = f.platforms) === null || _f$platforms4 === void 0 ? void 0 : _f$platforms4[0]) || '', size: _abPickDefaultSize(firstPlans) };
    }
  ...
  html += `<div class="fd-rating-block"${f.trustpilot ? ` onclick="openTpPopup('${f.trustpilot.url}')" style="cursor:pointer"` : ''}>
    ...
    <div class="fd-rating-detail">
      <span class="fd-tp-excellent">${t('tp_excellent')}</span>
      <div class="fd-stars">${Array(5).fill(0).map((_, i) => `<span class="fd-tp-star">${i < tpS ? '★' : '☆'}</span>`).join('')}</div>
      <div class="fd-reviews">${(((_f$trustpilot8 = f.trustpilot) === null || _f$trustpilot8 === void 0 ? void 0 : _f$trustpilot8.reviews) || f.reviews || 0).toLocaleString()} ${t('tp_reviews_on')} <b style="color:var(--tp-green)">Trustpilot</b></div>
    </div>
  </div>
...
function drwRenderCk(id, f) {var _f$platforms5, _fa$includes2;
  if (!f) f = FIRMS.find((x) => x.id === id);
  ...
  // Platform pills
  if ((_f$platforms5 = f.platforms) !== null && _f$platforms5 !== void 0 && _f$platforms5.length) {
    const pc = f.platforms.length <= 4 ? f.platforms.length : 3;
    h += `<div class="fd-step"><div class="fd-step-label"><span class="fd-step-dot" style="background:${f.color};box-shadow:0 0 8px ${f.color}40"></span>${t('fd_plataforma')}</div>
  ...
  if (plan) {var _match4;
    ...
    const oNum = parseFloat((pp.o || '').replace(/[^0-9.]/g, ''));
    const dNum = parseFloat((pp.d || '').replace(/[^0-9.]/g, ''));
    const cur = ((_match4 = (pp.d || '').match(/[€$]/)) === null || _match4 === void 0 ? void 0 : _match4[0]) || '$';
    const save = oNum && dNum && pp.o !== '—' ? (oNum - dNum).toFixed(2) : null;
...
`;
  ...
  // Includes
  if ((_fa$includes2 = fa.includes) !== null && _fa$includes2 !== void 0 && _fa$includes2.length) {
    h += `<div class="fd-includes"><div class="fd-inc-title">${t('fd_incluso_plano')}</div>
      <div class="fd-inc-grid">${fa.includes.map((i) => `<div class="fd-inc">${tf(i)}</div>`).join('')}</div></div>`;
  }
...
function toggleDrwSection(id) {var _document$getElementB14;
  (_document$getElementB14 = document.getElementById(id)) === null || _document$getElementB14 === void 0 || _document$getElementB14.classList.toggle('open');
...
function drwGoCheckout(firmId) {
  ...
  const f = FIRMS.find((x) => x.id === firmId);
  if (!cf || !f) {mcOpenFirm(firmId, (f === null || f === void 0 ? void 0 : f.link) || '#', f === null || f === void 0 ? void 0 : f.coupon, f === null || f === void 0 ? void 0 : f.name);return;}
...
function openTpPopup(url) {
  ...
  try {
    ...
    if (!popup || popup.closed) window.open(url, '_blank', 'noopener');else
    popup.focus();
...
function cpCoupon(code, firmId, loc) {
  ...
  track('coupon_copy', { coupon_code: code, firm_id: firmId, firm_name: f === null || f === void 0 ? void 0 : f.name, discount: f === null || f === void 0 ? void 0 : f.discount, location: loc, source: _src });
}
...
{ id: 'apex', name: 'Apex Trader Funding', short: 'Apex', coupon: null, discount: '90%', color: '#F97316', bg: 'rgba(249,115,22,0.12)',
  ...
  plansByType: {
    'Intraday Trail': [{ size: '25K', capital: '$25,000', goal: '$1,500', maxDD: '$1,000', orig: '$167', disc: '$16.70', featured: false }, { size: '50K', capital: '$50,000', goal: '$3,000', maxDD: '$2,500', orig: '$249', disc: '$24.90', featured: false }, { size: '100K', capital: '$100,000', goal: '$6,000', maxDD: '$3,000', orig: '$399', disc: '$39.90', featured: true }, { size: '150K', capital: '$150,000', goal: '$9,000', maxDD: '$4,500', orig: '$599', disc: '$59.90', featured: false }],
...
async function loadFirmsFromSupabase() {
  try {var _document$getElementB16, _document$getElementB17;
    ...
    if (window._dedicatedFirmSlug && !((_document$getElementB16 = document.getElementById('fd-overlay')) !== null && _document$getElementB16 !== void 0 && _document$getElementB16.classList.contains('show')) && !((_document$getElementB17 = document.getElementById('drw')) !== null && _document$getElementB17 !== void 0 && _document$getElementB17.classList.contains('open'))) {
...
function achSelType(fId, size, type) {var _CHECKOUT_FIRMS$find, _document$getElementB18;
  if (!achState[fId]) achState[fId] = {};
  if (!achState[fId][size]) achState[fId][size] = { type, plat: ((_CHECKOUT_FIRMS$find = CHECKOUT_FIRMS.find((f) => f.id === fId)) === null || _CHECKOUT_FIRMS$find === void 0 ? void 0 : _CHECKOUT_FIRMS$find.platforms[0]) || '' };
  achState[fId][size].type = type;
  const sid = size.replace(/[^a-z0-9]/gi, '_');
  (_document$getElementB18 = document.getElementById('tr-' + fId + '-' + sid)) === null || _document$getElementB18 === void 0 || _document$getElementB18.querySelectorAll('.ach-type-btn').forEach((b) => b.classList.toggle('sel', b.textContent.trim() === type));
  track('checkout_select', { firm_id: fId, field: 'type', value: type, size });
}
function achSelPlat(fId, size, plat) {var _CHECKOUT_FIRMS$find2, _document$getElementB19;
  if (!achState[fId]) achState[fId] = {};
  if (!achState[fId][size]) achState[fId][size] = { type: ((_CHECKOUT_FIRMS$find2 = CHECKOUT_FIRMS.find((f) => f.id === fId)) === null || _CHECKOUT_FIRMS$find2 === void 0 ? void 0 : _CHECKOUT_FIRMS$find2.types[0]) || '', plat };
  achState[fId][size].plat = plat;
  const sid = size.replace(/[^a-z0-9]/gi, '_');
  (_document$getElementB19 = document.getElementById('pr-' + fId + '-' + sid)) === null || _document$getElementB19 === void 0 || _document$getElementB19.querySelectorAll('.ach-plat-btn').forEach((b) => b.classList.toggle('sel', b.textContent.trim() === plat));
...
function achCopyCoupon() {const firm = CHECKOUT_FIRMS.find((f) => f.id === achActiveFirm);if (!(firm !== null && firm !== void 0 && firm.coupon)) return;navigator.clipboard.writeText(firm.coupon).then(() => {const _src = window._dedicatedFirmSlug ? 'dedicated' : 'homepage';showToast(t('toast_cupom_copiado').replace('{code}', firm.coupon));const _f = FIRMS.find((x) => x.id === achActiveFirm);track('coupon_copy', { coupon_code: firm.coupon, firm_id: achActiveFirm, firm_name: (_f === null || _f === void 0 ? void 0 : _f.name) || achActiveFirm, value: _fbVal(_f), location: 'checkout_header', source: _src });});}
...
function renderCmp() {
  const ids = ['c1', 'c2', 'c3'].map((id) => {var _document$getElementB20;return (_document$getElementB20 = document.getElementById(id)) === null || _document$getElementB20 === void 0 ? void 0 : _document$getElementB20.value;}).filter(Boolean);
...
function calcPS() {var _document$getElementB21, _document$getElementB22, _document$getElementB23, _document$getElementB24, _document$getElementB25, _document$getElementB26;
  const bal = parseFloat((_document$getElementB21 = document.getElementById('ps-bal')) === null || _document$getElementB21 === void 0 ? void 0 : _document$getElementB21.value) || 0;const risk = parseFloat((_document$getElementB22 = document.getElementById('ps-risk')) === null || _document$getElementB22 === void 0 ? void 0 : _document$getElementB22.value) || 0;const ent = parseFloat((_document$getElementB23 = document.getElementById('ps-ent')) === null || _document$getElementB23 === void 0 ? void 0 : _document$getElementB23.value) || 0;const sl = parseFloat((_document$getElementB24 = document.getElementById('ps-sl')) === null || _document$getElementB24 === void 0 ? void 0 : _document$getElementB24.value) || 0;const tp = parseFloat((_document$getElementB25 = document.getElementById('ps-tp')) === null || _document$getElementB25 === void 0 ? void 0 : _document$getElementB25.value) || 0;const mult = parseFloat((_document$getElementB26 = document.getElementById('ps-instr')) === null || _document$getElementB26 === void 0 ? void 0 : _document$getElementB26.value) || 50;
...
function qfinish() {
  setTimeout(() => {var _I18N$_currentLang, _I18N$en;
    ...
    const scores = {};
    FIRMS.forEach((f) => {var _f$tags, _f$tags2, _f$drawdown, _f$drawdown2, _f$drawdown3, _f$drawdown4;
      let s = 0;
      if (market === 'forex' && f.type === 'Forex') s += 3;else if (market === 'forex' && f.type !== 'Forex') s -= 2;
      if (market === 'futures' && (f.type === 'Futuros' || (_f$tags = f.tags) !== null && _f$tags !== void 0 && _f$tags.includes('Futuros'))) s += 3;else if (market === 'futures' && f.type === 'Forex' && !((_f$tags2 = f.tags) !== null && _f$tags2 !== void 0 && _f$tags2.includes('Futuros'))) s -= 2;
      if (market === 'both') s += 1;
      if (budget === 'low') {var _f$prices2;const cheapest = (_f$prices2 = f.prices) === null || _f$prices2 === void 0 ? void 0 : _f$prices2[0];if (cheapest) {const p = parseFloat(String(cheapest.n).replace(/[^0-9.]/g, ''));if (p && p < 30) s += 2;else if (p && p < 60) s += 1;}}
      if (budget === 'high' && f.scaling) s += 1;
      if (exp === 'beginner') {if (f.id === 'ftmo' || f.id === 'e2t') s += 2;if (f.minDays <= 1) s += 1;}
      if (exp === 'advanced' && f.scaling) s += 1;
      if (dd === 'trailing' && (_f$drawdown = f.drawdown) !== null && _f$drawdown !== void 0 && _f$drawdown.includes('Trail')) s += 2;else if (dd === 'static' && ((_f$drawdown2 = f.drawdown) !== null && _f$drawdown2 !== void 0 && _f$drawdown2.includes('Static') || (_f$drawdown3 = f.drawdown) !== null && _f$drawdown3 !== void 0 && _f$drawdown3.includes('Fixed'))) s += 2;else if (dd === 'eod' && (_f$drawdown4 = f.drawdown) !== null && _f$drawdown4 !== void 0 && _f$drawdown4.includes('EOD')) s += 2;
...
function calFilter(filter, btn) {
  ...
  if (filter === 'all') {calFilterCur = 'all';calFilterImp.clear();} else
  if (filter === 'h' || filter === 'm' || filter === 'l') {
  ...
  {calFilterCur = calFilterCur === filter ? 'all' : filter;}
  // escopo #cal-filters, não tocar nos botões .cal-f do heatmap
  document.querySelectorAll('#cal-filters .cal-f').forEach((b) => {
    const f = b.getAttribute('data-filter');
    if (f === 'all') b.classList.toggle('active', calFilterCur === 'all' && calFilterImp.size === 0);else
    if (f === 'h' || f === 'm' || f === 'l') b.classList.toggle('active', calFilterImp.has(f));else
    b.classList.toggle('active', calFilterCur === f);
  });
  renderCal();
}
...
async function loadCalendar(silent) {
  ...
  try {var _data$events;
    const lang = _currentLang || 'en';
    const res = await fetch(CAL_API + '?lang=' + lang);
    if (!res.ok) throw new Error('Calendar API error ' + res.status);
    const data = await res.json();
    if (!((_data$events = data.events) !== null && _data$events !== void 0 && _data$events.length)) throw new Error('No events');
    ...
    calEvents = data.events.map((ev) => {
      ...
      let day = 'Semana';
      if (dateStr === todayStr) day = 'Hoje';else
      if (dateStr === tmrStr) day = 'Amanhã';
...
function renderCal() {
  ...
  el.innerHTML = order.filter((d) => {var _groups$d;return (_groups$d = groups[d]) === null || _groups$d === void 0 ? void 0 : _groups$d.length;}).map((day) => {
...
async function startCheckout() {
  ...
  try {
    ...
    if (json.url) window.location.href = json.url;else
    if (json.error === 'Already subscribed') {alert(t('pro_already_subscribed'));if (btn) {btn.disabled = false;btn.textContent = origText;}} else
...
function showProSuccessOverlay() {var _currentUser2;
  // Deterministic transaction_id per user per day (GA4 dedupes repeated purchases)
  const _txId = 'pro_' + (((_currentUser2 = currentUser) === null || _currentUser2 === void 0 ? void 0 : _currentUser2.id) || MC_SESSION) + '_' + new Date().toISOString().slice(0, 10);
...
async function checkProBadge() {
  ...
  try {var _currentProfile;
    let isPro = false,hasSub = false;
    // Check VIP flag
    if (((_currentProfile = currentProfile) === null || _currentProfile === void 0 ? void 0 : _currentProfile.analysis_vip) === true) isPro = true;
...
function startPreviewTimer(gateId, wrapId, wrapClass) {
  ...
  _previewCountdown = setInterval(() => {var _document$getElementB27;
    ...
    const modalOpen = (_document$getElementB27 = document.getElementById('login-overlay')) === null || _document$getElementB27 === void 0 ? void 0 : _document$getElementB27.classList.contains('show');
    ...
    if (el) {const s = el.querySelector('.pvw-time');if (s) s.textContent = fmt;} else
    showPreviewBanner(fmt);
  }, 1000);
}
...
function onCountryChangeFor(prefix) {var _document$getElementB28;
  const country = (_document$getElementB28 = document.getElementById(prefix + '-country')) === null || _document$getElementB28 === void 0 ? void 0 : _document$getElementB28.value;
  if (!country) return;
...
async function onZipBlurFor(prefix) {var _document$getElementB29, _document$getElementB30;
  const zip = (_document$getElementB29 = document.getElementById(prefix + '-zip')) === null || _document$getElementB29 === void 0 ? void 0 : _document$getElementB29.value.trim();
  const country = (_document$getElementB30 = document.getElementById(prefix + '-country')) === null || _document$getElementB30 === void 0 ? void 0 : _document$getElementB30.value;
  ...
  try {
    if (cc === 'BR') {
      if (norm.length !== 8) {
        ...
        if (!r.ok) result = { ok: false, error: 'network_error', zip: norm };else
        {
          const d = await r.json();
          if (d.erro) result = { ok: false, error: 'zip_not_found', zip: norm };else
          result = {
            ok: true,
      ...
      if (r.status === 404) result = { ok: false, error: 'zip_not_found', zip: norm };else
      if (!r.ok) result = { ok: false, error: 'network_error', zip: norm };else
      {
        const d = await r.json();
...
async function saveLead(data) {var _Intl$DateTimeFormat;
  if (!rateLimit('saveLead', 5000)) return; // 5s cooldown
  const payload = {
    ...data,
    idioma: navigator.language || 'pt-BR',
    timezone: (Intl === null || Intl === void 0 || (_Intl$DateTimeFormat = Intl.DateTimeFormat()) === null || _Intl$DateTimeFormat === void 0 || (_Intl$DateTimeFormat = _Intl$DateTimeFormat.resolvedOptions()) === null || _Intl$DateTimeFormat === void 0 ? void 0 : _Intl$DateTimeFormat.timeZone) || '',
    ...MC_UTM,
  ...
  try {
    ...
    if (geo !== null && geo !== void 0 && geo.geo_country) {
...
function updateWaPlaceholder() {var _document$getElementB31;
  const ddi = ((_document$getElementB31 = document.getElementById('lv-ddi')) === null || _document$getElementB31 === void 0 ? void 0 : _document$getElementB31.value) || '+55';
...
function autoDetectDDI() {var _Intl$DateTimeFormat2;
  const lang = navigator.language || navigator.userLanguage || 'pt-BR';
  const tz = (Intl === null || Intl === void 0 || (_Intl$DateTimeFormat2 = Intl.DateTimeFormat()) === null || _Intl$DateTimeFormat2 === void 0 || (_Intl$DateTimeFormat2 = _Intl$DateTimeFormat2.resolvedOptions()) === null || _Intl$DateTimeFormat2 === void 0 ? void 0 : _Intl$DateTimeFormat2.timeZone) || '';
  let ddi = '+55'; // default BR
  if (lang.startsWith('en-US') || tz.includes('America/New_York') || tz.includes('America/Chicago') || tz.includes('America/Los_Angeles')) ddi = '+1';else
  if (lang.startsWith('en-GB') || tz.includes('Europe/London')) ddi = '+44';else
  if (lang.startsWith('pt-PT') || tz.includes('Europe/Lisbon')) ddi = '+351';else
  if (lang.startsWith('es-AR') || tz.includes('America/Argentina')) ddi = '+54';else
  if (lang.startsWith('es-MX') || tz.includes('America/Mexico')) ddi = '+52';else
  if (lang.startsWith('es-CO') || tz.includes('America/Bogota')) ddi = '+57';else
  if (lang.startsWith('es-CL') || tz.includes('America/Santiago')) ddi = '+56';else
  if (lang.startsWith('fr') || tz.includes('Europe/Paris')) ddi = '+33';else
  if (lang.startsWith('de') || tz.includes('Europe/Berlin')) ddi = '+49';else
  if (lang.startsWith('ar') || tz.includes('Asia/Dubai')) ddi = '+971';else
  if (lang.startsWith('ja') || tz.includes('Asia/Tokyo')) ddi = '+81';else
  if (tz.includes('Australia')) ddi = '+61';else
  if (tz.includes('America/Toronto') || tz.includes('America/Vancouver')) ddi = '+1-CA';
...
function getTraderName() {
  ...
  if (!n && typeof _currentUser !== 'undefined' && _currentUser) {var _currentUser$user_met, _currentUser$user_met2;
    n = (((_currentUser$user_met = _currentUser.user_metadata) === null || _currentUser$user_met === void 0 ? void 0 : _currentUser$user_met.name) || ((_currentUser$user_met2 = _currentUser.user_metadata) === null || _currentUser$user_met2 === void 0 ? void 0 : _currentUser$user_met2.full_name) || '').trim().split(/\s+/)[0] || '';
...
async function sendBot() {
  ...
  try {var _data$content;const res = await fetch('/api/bot', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ messages: botHist, lang: userLang, traderName: traderName || undefined, geo: geo || undefined }) });const data = await res.json();ty.classList.remove('show');bw && bw.classList.remove('typing');const reply = ((_data$content = data.content) === null || _data$content === void 0 || (_data$content = _data$content[0]) === null || _data$content === void 0 ? void 0 : _data$content.text) || (data.error ? friendlyErr : friendlyErr);botHist.push({ role: 'assistant', content: reply });saveBotHist();addBMsg('bot', reply);track('bot_message', { user_msg: txt.slice(0, 50), response_len: reply.length });} catch (e) {ty.classList.remove('show');bw && bw.classList.remove('typing');addBMsg('bot', friendlyErr);}
...
function submitLead(toolId) {var _document$getElementB32, _document$getElementB33, _document$getElementB34, _document$getElementB35;
  const name = (_document$getElementB32 = document.getElementById('lg-name-' + toolId)) === null || _document$getElementB32 === void 0 ? void 0 : _document$getElementB32.value.trim();
  const email = (_document$getElementB33 = document.getElementById('lg-email-' + toolId)) === null || _document$getElementB33 === void 0 ? void 0 : _document$getElementB33.value.trim();
  const wa = (_document$getElementB34 = document.getElementById('lg-wa-' + toolId)) === null || _document$getElementB34 === void 0 ? void 0 : _document$getElementB34.value.trim();
  const consent = (_document$getElementB35 = document.getElementById('lg-consent-' + toolId)) === null || _document$getElementB35 === void 0 ? void 0 : _document$getElementB35.checked;
...
function addPFTrade() {var _document$getElementB36;const val = parseFloat((_document$getElementB36 = document.getElementById('pf-trade')) === null || _document$getElementB36 === void 0 ? void 0 : _document$getElementB36.value) || 0;if (!val) {showToast(t('toast_digite_valor'));return;}const cfg = JSON.parse(localStorage.getItem('mc_pf_config') || 'null') || { balance: 100000, startBalance: 100000, target: 108000, ddLimit: 5 };cfg.balance = Math.round(cfg.balance + val);localStorage.setItem('mc_pf_config', JSON.stringify(cfg));document.getElementById('tm-body').innerHTML = renderToolContent('dashboard');showToast(val > 0 ? t('toast_trade_positivo') : t('toast_trade_negativo'));}
...
function addJTrade() {var _document$getElementB37, _document$getElementB38, _document$getElementB39, _document$getElementB40;const sym = (((_document$getElementB37 = document.getElementById('jn-sym')) === null || _document$getElementB37 === void 0 ? void 0 : _document$getElementB37.value) || '').trim().toUpperCase();const dir = ((_document$getElementB38 = document.getElementById('jn-dir')) === null || _document$getElementB38 === void 0 ? void 0 : _document$getElementB38.value) || 'Long';const pnl = (_document$getElementB39 = document.getElementById('jn-pnl')) === null || _document$getElementB39 === void 0 ? void 0 : _document$getElementB39.value;const note = (((_document$getElementB40 = document.getElementById('jn-note')) === null || _document$getElementB40 === void 0 ? void 0 : _document$getElementB40.value) || '').trim();if (!sym || !pnl) {showToast(t('toast_preencha_simbolo_pnl'));return;}const trades = JSON.parse(localStorage.getItem('mc_journal') || '[]');trades.push({ sym, dir, pnl: parseFloat(pnl), note, ts: new Date().toISOString() });localStorage.setItem('mc_journal', JSON.stringify(trades));document.getElementById('tm-body').innerHTML = renderToolContent('journal');track('journal_add_trade', { symbol: sym, direction: dir, pnl: parseFloat(pnl) });}
...
function runBacktest() {var _document$getElementB41, _document$getElementB42, _document$getElementB43, _document$getElementB44;const wr = parseFloat((_document$getElementB41 = document.getElementById('bt-wr')) === null || _document$getElementB41 === void 0 ? void 0 : _document$getElementB41.value) / 100 || .55;const risk = parseFloat((_document$getElementB42 = document.getElementById('bt-risk')) === null || _document$getElementB42 === void 0 ? void 0 : _document$getElementB42.value) || 200;const rew = parseFloat((_document$getElementB43 = document.getElementById('bt-rew')) === null || _document$getElementB43 === void 0 ? void 0 : _document$getElementB43.value) || 400;const n = parseInt((_document$getElementB44 = document.getElementById('bt-n')) === null || _document$getElementB44 === void 0 ? void 0 : _document$getElementB44.value) || 100;let bal = 100000;const equity = [100000];let maxBal = 100000,maxDD = 0,wins = 0;for (let i = 0; i < n; i++) {const win = Math.random() < wr;bal += win ? rew : -risk;if (win) wins++;equity.push(Math.max(0, bal));maxBal = Math.max(maxBal, bal);maxDD = Math.max(maxDD, (maxBal - bal) / maxBal * 100);}const r = { equity, wins, n, finalBal: bal, maxDD, profitFactor: wins * rew / ((n - wins) * risk), rr: (rew / risk).toFixed(2), wr: (wr * 100).toFixed(0) };localStorage.setItem('mc_bt_results', JSON.stringify(r));document.getElementById('tm-body').innerHTML = renderToolContent('backtester');track('backtest_run', { win_rate: r.wr, trades: n, profit_factor: r.profitFactor.toFixed(2) });}
...
function addAlert() {var _document$getElementB45, _document$getElementB46, _document$getElementB47, _document$getElementB48;const type = (_document$getElementB45 = document.getElementById('al-type')) === null || _document$getElementB45 === void 0 ? void 0 : _document$getElementB45.value;const sym = (((_document$getElementB46 = document.getElementById('al-sym')) === null || _document$getElementB46 === void 0 ? void 0 : _document$getElementB46.value) || '').trim().toUpperCase();const val = (_document$getElementB47 = document.getElementById('al-val')) === null || _document$getElementB47 === void 0 ? void 0 : _document$getElementB47.value;const channel = (_document$getElementB48 = document.getElementById('al-ch')) === null || _document$getElementB48 === void 0 ? void 0 : _document$getElementB48.value;if (!sym || !val) {showToast(t('toast_preencha_simbolo_valor'));return;}const alerts = JSON.parse(localStorage.getItem('mc_alerts') || '[]');alerts.push({ type, sym, val: parseFloat(val), channel, active: true, ts: new Date().toISOString() });localStorage.setItem('mc_alerts', JSON.stringify(alerts));document.getElementById('tm-body').innerHTML = renderToolContent('alerts');showToast(t('toast_alerta_criado'));track('alert_create', { type, symbol: sym, value: parseFloat(val), channel });}
function toggleAlert(i) {var _alerts$i, _alerts$i2;const alerts = JSON.parse(localStorage.getItem('mc_alerts') || '[]');if (alerts[i]) alerts[i].active = !alerts[i].active;localStorage.setItem('mc_alerts', JSON.stringify(alerts));document.getElementById('tm-body').innerHTML = renderToolContent('alerts');track('alert_toggle', { symbol: (_alerts$i = alerts[i]) === null || _alerts$i === void 0 ? void 0 : _alerts$i.sym, active: (_alerts$i2 = alerts[i]) === null || _alerts$i2 === void 0 ? void 0 : _alerts$i2.active });}
function deleteAlert(i) {const alerts = JSON.parse(localStorage.getItem('mc_alerts') || '[]');const deleted = alerts[i];alerts.splice(i, 1);localStorage.setItem('mc_alerts', JSON.stringify(alerts));document.getElementById('tm-body').innerHTML = renderToolContent('alerts');track('alert_delete', { symbol: deleted === null || deleted === void 0 ? void 0 : deleted.sym });}
...
function isOAuthUser() {var _currentUser3;
  return !!((_currentUser3 = currentUser) !== null && _currentUser3 !== void 0 && (_currentUser3 = _currentUser3.app_metadata) !== null && _currentUser3 !== void 0 && _currentUser3.provider && currentUser.app_metadata.provider !== 'email');
}
...
function togglePw(btn) {
  ...
  if (input.type === 'password') {input.type = 'text';btn.style.color = 'var(--gold)';} else
  {input.type = 'password';btn.style.color = '';}
}
...
async function doAuthSignup() {var _document$getElementB49, _document$getElementB50, _document$getElementB51;
  ...
  const fullNameRaw = ((_document$getElementB49 = document.getElementById('auth-signup-fullname')) === null || _document$getElementB49 === void 0 ? void 0 : _document$getElementB49.value.trim()) || '';
  const email = document.getElementById('auth-signup-email').value.trim();
  const pass = document.getElementById('auth-signup-pass').value;
  const terms = (_document$getElementB50 = document.getElementById('auth-signup-terms')) === null || _document$getElementB50 === void 0 ? void 0 : _document$getElementB50.checked;
  const marketing = !!((_document$getElementB51 = document.getElementById('auth-signup-marketing')) !== null && _document$getElementB51 !== void 0 && _document$getElementB51.checked);
  _saveIdentity(email, '');
  ...
  if (marketing && data !== null && data !== void 0 && data.user) {
    try {
  ...
  if (_gwPendingSlug && _gwPendingIg && data !== null && data !== void 0 && data.user) {
  ...
  if (wrap) {
    ...
    wrap.querySelectorAll('.up-task-b').forEach((b) => {
      b.onclick = async () => {
        ...
        } else if (task.page) {go(task.page);return;} else
        if (task.url) {try {window.open(task.url, '_blank', 'noopener');} catch (e) {}}
        b.disabled = true;
...
async function saveProfile() {
  ...
  const _val = (id) => {var _document$getElementB52;return (((_document$getElementB52 = document.getElementById(id)) === null || _document$getElementB52 === void 0 ? void 0 : _document$getElementB52.value) || '').trim();};
...
async function checkAuthSession() {
  try {
    ...
    try {
      ...
      if (s2 !== null && s2 !== void 0 && s2.user) {await loadUserSession(s2.user);return;}
...
document.addEventListener('DOMContentLoaded', async () => {var _CHECKOUT_FIRMS$2, _document$getElementB53;
  ...
  renderQuiz();
  renderAchFirmTabs();
  achSelectFirm(((_CHECKOUT_FIRMS$2 = CHECKOUT_FIRMS[0]) === null || _CHECKOUT_FIRMS$2 === void 0 ? void 0 : _CHECKOUT_FIRMS$2.id) || 'apex');
  renderFaq();
  renderPolicies();
  showCookieBanner();
  autoDetectDDI();
  ...
  if (_isFirmPage) {
    ...
    if (FIRMS.find((x) => x.id === _resolvedId)) document.body.style.opacity = '1';else
    setTimeout(() => {document.body.style.opacity = '1';}, 2500); // safety fallback
  ...
  if (_signupPath || _urlParams.has('signup')) {var _authReadyPromise3;
    const _gwSlug = _urlParams.get('gw') || '';
    // NÃO limpa a URL: o /signup fica fixo na barra (pra automação IG / compartilhar o link).
    (_authReadyPromise3 = _authReadyPromise) === null || _authReadyPromise3 === void 0 || _authReadyPromise3.then(async () => {
      let _ig = '';
      if (_gwSlug) {
  ...
  if (_fdCurrent && !_fdClosing && (_document$getElementB53 = document.getElementById('fd-overlay')) !== null && _document$getElementB53 !== void 0 && _document$getElementB53.classList.contains('show')) {
...
function renderGEXHeatmap() {
  ...
  container.innerHTML = items.map((item) => {
    ...
    const rows = displayStrikes.map((strike) => {
      ...
      const cells = bd.map((exp) => {var _lookup$exp$expiratio;
        const gex = ((_lookup$exp$expiratio = lookup[exp.expiration]) === null || _lookup$exp$expiratio === void 0 ? void 0 : _lookup$exp$expiratio[strike]) || 0;
...
function renderGEX(items) {
  ...
  grid.innerHTML = items.map((item) => {var _topStrikes$, _topStrikes;
    ...
    const minStrike = ((_topStrikes$ = topStrikes[0]) === null || _topStrikes$ === void 0 ? void 0 : _topStrikes$.strike) || spot - 100;
    const maxStrike = ((_topStrikes = topStrikes[topStrikes.length - 1]) === null || _topStrikes === void 0 ? void 0 : _topStrikes.strike) || spot + 100;
...
(function () {
  ...
  window.addEventListener('unhandledrejection', function (e) {var _e$reason;
    if (!rateLimit('promise_error', 5000)) return;
    track('js_error', { message: ('Promise: ' + (((_e$reason = e.reason) === null || _e$reason === void 0 ? void 0 : _e$reason.message) || String(e.reason) || '')).slice(0, 100), page: _currentPage || 'home' });
  });
...
async function subscribeNewsletter(e) {
  ...
  const email = ((input === null || input === void 0 ? void 0 : input.value) || '').trim().toLowerCase();
...
async function cemVerifyCode() {var _currentUser4, _currentProfile2;
  ...
  const email = _cemPendingEmail || ((_currentUser4 = currentUser) === null || _currentUser4 === void 0 ? void 0 : _currentUser4.email) || ((_currentProfile2 = currentProfile) === null || _currentProfile2 === void 0 ? void 0 : _currentProfile2.email) || '';
...
function showConfirmEmailModal(state) {var _currentUser5, _currentProfile3;
  state = state || 'pending';
  const email = _cemPendingEmail || ((_currentUser5 = currentUser) === null || _currentUser5 === void 0 ? void 0 : _currentUser5.email) || ((_currentProfile3 = currentProfile) === null || _currentProfile3 === void 0 ? void 0 : _currentProfile3.email) || '';
...
function showGiveaway(gw, trigger) {
  ...
  if (heroImg && gw.hero_image) {var _gw$prize_label;heroImg.src = gw.hero_image;heroImg.alt = ((_gw$prize_label = gw.prize_label) === null || _gw$prize_label === void 0 ? void 0 : _gw$prize_label.replace(/<[^>]+>/g, '')) || 'Giveaway prize';}
  if (gw.draw_date) {
  ...
  const _ftR = bd === null || bd === void 0 ? void 0 : bd.querySelector('.g2-ft');if (_ftR) _ftR.style.display = '';
...
async function giveawaySubmit() {var _bd$dataset;
  const bd = document.getElementById('gw-bd');
  const slug = (bd === null || bd === void 0 || (_bd$dataset = bd.dataset) === null || _bd$dataset === void 0 ? void 0 : _bd$dataset.slug) || '';
  ...
  if (name.length < 2) {showErr('Please enter your name.');nameEl === null || nameEl === void 0 || nameEl.focus();return;}
  if (!/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(email)) {showErr('Please enter a valid email.');emailEl === null || emailEl === void 0 || emailEl.focus();return;}
  ...
  const ftHide = bd === null || bd === void 0 ? void 0 : bd.querySelector('.g2-ft');if (ftHide) ftHide.style.display = 'none'; // rodape só no form
