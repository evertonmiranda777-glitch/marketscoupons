...
/* DATA */
const FIRMS=[
  {id:'apex',name:'Apex Trader Funding',type:'Futuros',color:'#F97316',bg:'rgba(249,115,22,0.12)',icon:'A',icon_url:'img/Firms/apex.png',rating:4.4,reviews:18382,discount:90,dtype:'lifetime',coupon:'MARKET',badge:{label:'Maior Desconto',color:'#F97316',bg:'rgba(249,115,22,0.15)'},link:'https://apextraderfunding.com/member/aff/go/evertonmiranda',tags:['Futuros','Lifetime','Trailing DD'],platforms:['Rithmic','Tradovate','NinjaTrader','WealthCharts'],minDays:1,evalDays:30,drawdown:'Trailing/EOD',split:'100%',ddPct:'-5% trail',target:'8%',scaling:'Sim',prices:[{a:'25K',n:'$19.90',o:'$199',n2:'$29.90',o2:'$299'},{a:'50K',n:'$24.90',o:'$249',n2:'$34.90',o2:'$349'},{a:'100K',n:'$39.90',o:'$399',n2:'$59.90',o2:'$599'},{a:'150K',n:'$59.90',o:'$599',n2:'$79.90',o2:'$799'}],price_types:['Intraday','EOD'],perks:['No daily loss limit','No scaling rules','Payout in 5 days','Up to 20 accounts','No recurring fees'],proibido:['Copy trading between accounts','Latency arbitrage'],newsTrading:true,day1Payout:true,leverage:'1:1',consistency:'Not required',payoutSpeed:'5 days',maxAccounts:'20',desc:'Apex Trader Funding is one of the largest futures prop firms in the US. Known for aggressive discounts and flexible rules.',trustpilot:{score:4.4,reviews:18382,url:'https://www.trustpilot.com/review/apextraderfunding.com'}},
  {id:'bulenox',name:'Bulenox',type:'Futuros',color:'#3B82F6',bg:'rgba(59,130,246,0.12)',icon:'B',icon_url:'img/Firms/bulenox.png',rating:4.8,reviews:1516,discount:89,dtype:'lifetime',coupon:'MARKET89',badge:{label:'Melhor Split 90%',color:'#3B82F6',bg:'rgba(59,130,246,0.15)'},link:'https://bulenox.com/member/aff/go/marketcoupons',tags:['Futuros','Lifetime','1 dia'],platforms:['Rithmic','NinjaTrader'],minDays:1,evalDays:null,drawdown:'Trailing',split:'90%',ddPct:'Varies by size',target:'Varies by size',scaling:'Ate $400K',prices:[{a:'25K',n:'$15.95',o:'$145'},{a:'50K',n:'$13.75',o:'$125'},{a:'100K',n:'$17.05',o:'$155'},{a:'150K',n:'$35.75',o:'$325'},{a:'250K',n:'$58.85',o:'$535'}],perks:['Pass in 1 day','No consistency rule','News trading allowed','Weekly payouts','Scaling up to $400K','First $10K at 100% split','14-day free Rithmic trial'],proibido:['Latency arbitrage','Copy trading between accounts'],newsTrading:true,day1Payout:true,leverage:'1:1',consistency:'Not required',payoutSpeed:'Weekly',maxAccounts:'5',desc:'Bulenox is a futures prop firm with simplified rules. Pass in 1 day, no consistency rule required.',trustpilot:{score:4.8,reviews:1516,url:'https://www.trustpilot.com/review/bulenox.com'}},
  {id:'ftmo',name:'FTMO',type:'Forex',color:'#22C55E',bg:'rgba(34,197,94,0.12)',icon:'F',icon_url:'img/Firms/ftmo.png',rating:4.8,reviews:41417,discount:19,dtype:'best value',coupon:null,badge:{label:'Líder Forex',color:'#22C55E',bg:'rgba(34,197,94,0.15)'},link:'https://trader.ftmo.com/?affiliates=eyfIptUCGgfcfaUlyrRP',tags:['Forex','Free Trial','90% Split'],platforms:['MT4','MT5','cTrader'],minDays:0,evalDays:30,drawdown:'Fixed',split:'90%',ddPct:'-3% / -10%',target:'10%',scaling:'Ate $2M',prices:[{a:'1-Step 10K',n:'€79',o:'—'},{a:'1-Step 25K',n:'€199',o:'—'},{a:'1-Step 50K',n:'€319',o:'—'},{a:'1-Step 100K',n:'€499',o:'—'},{a:'1-Step 200K',n:'€999',o:'—'},{a:'2-Step 10K',n:'€79',o:'—'},{a:'2-Step 25K',n:'€199',o:'—'},{a:'2-Step 50K',n:'€319',o:'—'},{a:'2-Step 100K',n:'€499',o:'—'},{a:'2-Step 200K',n:'€999',o:'—'}],perks:['1-Step challenge (NEW)','Up to 90% profit split','Unlimited trading period','Free Trial available','$500M+ paid worldwide','3.5M+ customers','FTMO Academy included','Support in 18 languages','Since 2015','Best Day Rule 50%'],proibido:['Latency arbitrage','Spread manipulation'],newsTrading:false,day1Payout:false,leverage:'1:100',consistency:'50% Best Day',payoutSpeed:'14 days',maxAccounts:'2',desc:'FTMO is the largest and most trusted Forex prop firm, founded in 2015. Over 3.5M clients, $500M+ paid out, 4.8 Trustpilot rating with 41K+ reviews.',trustpilot:{score:4.8,reviews:41417,url:'https://www.trustpilot.com/review/ftmo.com'}},
  {id:'tpt',name:'Take Profit Trader',type:'Futuros',color:'#A855F7',bg:'rgba(168,85,247,0.12)',icon:'T',icon_url:'img/Firms/tpt.png',rating:4.4,reviews:8623,discount:40,dtype:'lifetime',coupon:'MARKET40',link:'https://takeprofittrader.com/?referralCode=MARKET40',tags:['Futuros','Lifetime','Saque dia 1'],platforms:['NinjaTrader','TradingView','Tradovate','Rithmic','Quantower','MotiveWave'],minDays:5,evalDays:null,drawdown:'EOD Trailing',split:'90%',ddPct:'Varies by size',target:'Varies by size',scaling:'No',prices:[{a:'25K',n:'$90',o:'$150'},{a:'50K',n:'$102',o:'$170'},{a:'75K',n:'$147',o:'$245'},{a:'100K',n:'$198',o:'$330'},{a:'150K',n:'$216',o:'$360'}],perks:['Day-1 payouts','No activation fee','No Daily Loss Limit','Immediate withdrawals','No max withdrawal','Up to 3 PRO resets','PRO fee $130 one-time','No consistency rule on PRO','15+ platforms available'],proibido:['Trading bots','Counter positions','Consistency rule on test'],newsTrading:true,day1Payout:true,leverage:'1:1',consistency:'Not required',payoutSpeed:'Instant',maxAccounts:'5',desc:'Take Profit Trader stands out with day-1 payouts and no activation fee.',trustpilot:{score:4.4,reviews:8623,url:'https://www.trustpilot.com/review/takeprofittrader.com'}},
  {id:'fn',name:'FundedNext',type:'Forex/Futuros',color:'#06B6D4',bg:'rgba(6,182,212,0.12)',icon:'N',icon_url:'img/Firms/fn.png',rating:4.5,reviews:64434,discount:30,dtype:'1 desafio',coupon:'FNF30',badge:{label:'Mais Avaliações',color:'#06B6D4',bg:'rgba(6,182,212,0.15)'},link:'https://fundednext.com/?fpr=everton33',tags:['Forex','Futuros','Payout 24h','Sem limite'],platforms:['MT4','MT5','cTrader','Match-Trader','Rithmic'],minDays:5,evalDays:null,drawdown:'Fixed',split:'95%',ddPct:'-5% / -10%',target:'8% / 5%',scaling:'Até $4M',prices:[{a:'Stellar 2-Step 25K',n:'$132.99',o:'$189.99'},{a:'Stellar 2-Step 50K',n:'$188.99',o:'$269.99'},{a:'Stellar 2-Step 100K',n:'$349.99',o:'$499.99'},{a:'Stellar 1-Step 25K',n:'$167.99',o:'$239.99'},{a:'Stellar 1-Step 50K',n:'$237.99',o:'$339.99'},{a:'Stellar 1-Step 100K',n:'$454.99',o:'$649.99'},{a:'Stellar Instant 5K',n:'$104.99',o:'$149.99'},{a:'Stellar Instant 10K',n:'$209.99',o:'$299.99'},{a:'Stellar Instant 20K',n:'$419.99',o:'$599.99'},{a:'Bolt 50K (Futures)',n:'$69.99',o:'$99.99'},{a:'Rapid 25K (Futures)',n:'$62.99',o:'$89.99'},{a:'Rapid 50K (Futures)',n:'$111.99',o:'$159.99'},{a:'Rapid 100K (Futures)',n:'$195.99',o:'$279.99'},{a:'Legacy 25K (Futures)',n:'$55.99',o:'$79.99'},{a:'Legacy 50K (Futures)',n:'$104.99',o:'$149.99'},{a:'Legacy 100K (Futures)',n:'$174.99',o:'$249.99'}],perks:['Up to 95% performance reward','15% reward in challenge phase','Guaranteed 24h payout','No time limit','News trading allowed','Spreads from 0.0 pips','Leverage up to 1:100','$288M+ total rewarded','No activation fee (Futures)'],proibido:['Latency arbitrage','Consistency rule 40% (challenge only)'],newsTrading:true,day1Payout:true,leverage:'1:100',consistency:'40%',payoutSpeed:'24h',maxAccounts:'3',desc:'FundedNext offers Forex and Futures challenges with up to 95% profit split, 15% performance reward during evaluation, and $288M+ total rewarded to 110K+ traders.',trustpilot:{score:4.5,reviews:64434,url:'https://www.trustpilot.com/review/fundednext.com'}},
  {id:'e2t',name:'Earn2Trade',type:'Futuros',color:'#F59E0B',bg:'rgba(245,158,11,0.12)',icon:'E',icon_url:'img/Firms/e2t.png',rating:4.7,reviews:4721,discount:60,dtype:'career path',coupon:'MARKETSCOUPONS',badge:{label:'Scaling $400K',color:'#F59E0B',bg:'rgba(245,158,11,0.15)'},link:'https://www.earn2trade.com/purchase?plan=TCP25&a_pid=marketscoupons&a_bid=2e8e8a14',tags:['Futuros','Journalytix','Scaling $400K'],platforms:['Rithmic','NinjaTrader','Finamark','Tradovate','TradingView'],minDays:10,evalDays:null,drawdown:'EOD Fixed',split:'80%',ddPct:'Fixed EOD',target:'Varies by plan',scaling:'Ate $400K',prices:[{a:'TCP25 (25K)',n:'$60',o:'$150'},{a:'TCP50 (50K)',n:'$76',o:'$190'},{a:'TCP100 (100K)',n:'$140',o:'$350'},{a:'GAU50 (50K)',n:'$68',o:'$170'},{a:'GAU100 (100K)',n:'$126',o:'$315'},{a:'GAU150 (150K)',n:'$150',o:'$375'},{a:'GAU200 (200K)',n:'$220',o:'$550'}],perks:['Free NinjaTrader/Finamark license','Free Journalytix license','Free reset when rebilled','Scaling up to $400K','Education catalog included','Simulator account for practice','Guaranteed funding offer on pass'],proibido:['HFT','Latency arbitrage'],newsTrading:false,day1Payout:false,leverage:'1:1',consistency:'Yes',payoutSpeed:'Monthly',maxAccounts:'2',desc:'Earn2Trade focuses on education and development with scaling up to $400K.',trustpilot:{score:4.7,reviews:4721,url:'https://www.trustpilot.com/review/www.earn2trade.com'}},
  {id:'the5ers',name:'The5ers',type:'Forex/Futuros',color:'#10B981',bg:'rgba(16,185,129,0.12)',icon:'5',icon_url:'img/Firms/the5ers.png',rating:4.7,reviews:23078,discount:10,dtype:'especial',coupon:null,badge:{label:'Desde 2016',color:'#10B981',bg:'rgba(16,185,129,0.15)'},link:'https://www.the5ers.com/?afmc=19jp',tags:['Forex','Futuros','Scaling $4M','Static DD'],platforms:['MT5','TradingView','Rithmic'],minDays:3,evalDays:null,drawdown:'Static',split:'100%',ddPct:'-3% / -6%',target:'Varies by plan',scaling:'Ate $4M',prices:[{a:'Hyper 5K',n:'$39',o:'—'},{a:'Hyper 10K',n:'$85',o:'—'},{a:'Hyper 20K',n:'$175',o:'—'},{a:'Pro 5K',n:'$74',o:'—'},{a:'Pro 10K',n:'$140',o:'—'},{a:'Pro 20K',n:'$270',o:'—'},{a:'High Stakes 2.5K',n:'$19',o:'—'},{a:'High Stakes 5K',n:'$39',o:'—'},{a:'High Stakes 10K',n:'$75',o:'—'},{a:'High Stakes 25K',n:'$175',o:'—'},{a:'High Stakes 50K',n:'$315',o:'—'},{a:'High Stakes 100K',n:'$575',o:'—'},{a:'Bootcamp 20K',n:'$22',o:'—'},{a:'Bootcamp 100K',n:'$99',o:'—'},{a:'Bootcamp 250K',n:'$225',o:'—'},{a:'Futures 25K',n:'$50',o:'—'},{a:'Futures 50K',n:'$99',o:'—'},{a:'Rebate 25K',n:'$150',o:'—'},{a:'Rebate 50K',n:'$299',o:'—'}],perks:['6 programs: Hyper Growth, Pro Growth, High Stakes, Bootcamp, Futures Basecamp, Futures Rebate','Scale up to $4M','Up to 100% profit split','No time limit','Leverage 1:30','Since 2016 (10yr anniversary)','24/7 support','Bootcamp starts at $22','Multi-currency: USD/EUR/GBP/INR'],proibido:['30-day inactivity','More than 4 active accounts','Consistency rule 30% per position (Futures)'],newsTrading:true,day1Payout:false,leverage:'1:30',consistency:'Not required',payoutSpeed:'16h avg',maxAccounts:'4',desc:'The5ers has been funding traders since 2016. Offers CFDs and Futures with 6 different programs, scaling up to $4M, and up to 100% profit split. 23K+ Trustpilot reviews.',trustpilot:{score:4.7,reviews:23078,url:'https://www.trustpilot.com/review/the5ers.com'}},
  {id:'fundingpips',name:'Funding Pips',type:'Forex',color:'#6366F1',bg:'rgba(99,102,241,0.12)',icon:'P',icon_url:'img/Firms/fundingpips.png',rating:4.5,reviews:51305,discount:20,dtype:'1 compra',coupon:'31985EAA',badge:{label:'$200M+ Pagos',color:'#6366F1',bg:'rgba(99,102,241,0.15)'},link:'https://app.fundingpips.com/register?ref=31985EAA',tags:['Forex','100% Split','3 Plataformas'],platforms:['MT5','Match-Trader','cTrader'],minDays:1,evalDays:null,drawdown:'Static',split:'100%',ddPct:'-3% / -5%',target:'Varies by plan',scaling:'Sim',prices:[{a:'Zero 5K',n:'$55.20',o:'$69'},{a:'Zero 10K',n:'$79.20',o:'$99'},{a:'Zero 25K',n:'$159.20',o:'$199'},{a:'Zero 50K',n:'$239.20',o:'$299'},{a:'Zero 100K',n:'$399.20',o:'$499'},{a:'Zero 200K',n:'$798.40',o:'$998'},{a:'1-Step 5K',n:'$47.20',o:'$59'},{a:'1-Step 10K',n:'$79.20',o:'$99'},{a:'1-Step 25K',n:'$159.20',o:'$199'},{a:'1-Step 50K',n:'$255.20',o:'$319'},{a:'1-Step 100K',n:'$444',o:'$555'},{a:'2-Step 5K',n:'$28.80',o:'$36'},{a:'2-Step 10K',n:'$52.80',o:'$66'},{a:'2-Step 25K',n:'$124.80',o:'$156'},{a:'2-Step 50K',n:'$231.20',o:'$289'},{a:'2-Step 100K',n:'$423.20',o:'$529'},{a:'Pro 5K',n:'$23.20',o:'$29'},{a:'Pro 10K',n:'$44',o:'$55'},{a:'Pro 25K',n:'$87.20',o:'$109'},{a:'Pro 50K',n:'$175.20',o:'$219'},{a:'Pro 100K',n:'$319.20',o:'$399'},{a:'Pro 200K',n:'$638.40',o:'$798'}],perks:['4 programs: Zero, 1-Step, 2-Step, Pro','Up to 100% profit split','Weekly/Bi-weekly/On Demand/Monthly payouts','Daily 80% payout (Pro Beta)','Leverage up to 1:100','Swap Free add-on (+10%)','No time limit','Consistency reward 15% (Zero)'],proibido:['HFT','Latency arbitrage'],newsTrading:true,day1Payout:false,leverage:'1:100',consistency:'Not required',payoutSpeed:'On Demand',maxAccounts:'3',desc:'Funding Pips offers 4 evaluation programs from instant funding (Zero) to affordable 2-step challenges. Up to 100% profit split with flexible payout cycles.',trustpilot:{score:4.5,reviews:51305,url:'https://www.trustpilot.com/review/fundingpips.com'}},
  {id:'brightfunded',name:'BrightFunded',type:'Forex',color:'#00C9A7',bg:'#000000',icon:'B',icon_url:'img/Firms/brightfunded.png',rating:4.5,reviews:528,discount:20,dtype:'easter',coupon:'CLNLTPxtT4Sok0PzHaRIIQ',badge:{label:'Payout 24h',color:'#00C9A7',bg:'rgba(0,201,167,0.15)'},link:'https://brightfunded.com/a/CLNLTPxtT4Sok0PzHaRIIQ',tags:['Forex','Static DD','100% Split'],platforms:['MT5','DXtrade','cTrader'],minDays:5,evalDays:null,drawdown:'Static',split:'100%',ddPct:'-10% / -5%',target:'8% / 5%',scaling:'Até $400K',prices:[{a:'5K',n:'€44',o:'€55'},{a:'10K',n:'€76',o:'€95'},{a:'25K',n:'€156',o:'€195'},{a:'50K',n:'€236',o:'€295'},{a:'100K',n:'€396',o:'€495'},{a:'200K',n:'€780',o:'€975'}],perks:['Up to 100% profit split','Scale up to $400K','Guaranteed 24h payout (7-day cycle)','15% profit in challenge phase','Trade2Earn loyalty program','No consistency rules','Refundable fee','150+ instruments','27,500+ active traders','$13M+ paid to traders','24/7 live support'],proibido:['Arbitrage','Hedging between accounts','Grid trading','HFT'],newsTrading:true,day1Payout:false,leverage:'1:100',consistency:'Not required',payoutSpeed:'24h',maxAccounts:'3',desc:'BrightFunded offers a 2-step challenge with up to 100% profit split, no consistency rules, guaranteed 24h payouts, and scaling up to $400K. Prices in EUR.',trustpilot:{score:4.5,reviews:528,url:'https://www.trustpilot.com/review/brightfunded.com'}},
  {id:'e8',name:'E8 Markets',type:'Forex',color:'#FF4400',bg:'rgba(255,68,0,0.12)',icon:'E',icon_url:'img/Firms/e8.png',rating:4.4,reviews:3230,discount:10,dtype:'1 compra',coupon:'MARKET',badge:{label:'DD Flexível',color:'#FF4400',bg:'rgba(255,68,0,0.15)'},link:'https://e8markets.com/d/MARKET',tags:['Forex','Futuros','Crypto'],platforms:['MT5','Match-Trader'],minDays:1,evalDays:null,drawdown:'EOD/Dynamic',split:'80-100%',ddPct:'-3% / -6%',target:'6% / 9%',scaling:'Up to $1M',prices:[{a:'$25K Signature',n:'$99',o:'$110'},{a:'$50K Signature',n:'$135',o:'$150'},{a:'$100K Signature',n:'$234',o:'$260'},{a:'$150K Signature',n:'$351',o:'$390'},{a:'$5K E8 One',n:'$54',o:'$60'},{a:'$10K E8 One',n:'$81',o:'$90'},{a:'$25K E8 One',n:'$153',o:'$170'},{a:'$50K E8 One',n:'$234',o:'$260'},{a:'$100K E8 One',n:'$439',o:'$488'},{a:'$200K E8 One',n:'$836',o:'$929'},{a:'$400K E8 One',n:'$1,619',o:'$1,799'},{a:'$500K E8 One',n:'$2,069',o:'$2,299'}],perks:['No activation fee','Pass in 1 day','3 markets: Forex, Futures, Crypto','Configurable drawdown 4-14%','Split up to 100%','Accounts up to $500K','1-on-1 Mentorship','Team rewards','Money back guarantee','Paid in as little as 3 days','$70M+ paid since 2021'],proibido:['HFT','Latency arbitrage','Hedging entre contas'],newsTrading:true,day1Payout:true,leverage:'1:100',consistency:'Not required',payoutSpeed:'3 days',maxAccounts:'3',desc:'E8 Markets offers $5K to $500K accounts in Forex, Futures and Crypto. Two products: Signature (EOD drawdown, 80% split) and E8 One (dynamic configurable drawdown, up to 100% split).',trustpilot:{score:4.4,reviews:3230,url:'https://www.trustpilot.com/review/e8markets.com'}},
  {id:'cti',name:'City Traders Imperium',type:'Forex',color:'#0A74DA',bg:'rgba(10,116,218,0.12)',icon:'C',icon_url:'img/Firms/cti.png',rating:4.3,reviews:1681,discount:30,dtype:'1 compra',coupon:'APR30',badge:{label:'VIP Program',color:'#0A74DA',bg:'rgba(10,116,218,0.15)'},link:'https://app.citytradersimperium.com/user-auth/register?referral_code=1331c5&utm_source=client&utm_medium=referral&utm_id=1331c5',tags:['Forex','5 Programs','100% Split'],platforms:['Match-Trader'],minDays:3,evalDays:null,drawdown:'Static/EOD',split:'100%',ddPct:'Varies by plan',target:'Varies by plan',scaling:'Sim',prices:[{a:'1-Step 2.5K',n:'$27',o:'$35'},{a:'1-Step 5K',n:'$41',o:'$59'},{a:'1-Step 10K',n:'$76',o:'$109'},{a:'1-Step 25K',n:'$139',o:'$199'},{a:'1-Step 50K',n:'$280',o:'$399'},{a:'1-Step 100K',n:'$412',o:'$589'},{a:'2-Step 2.5K',n:'$34',o:'$49'},{a:'2-Step 5K',n:'$48',o:'$69'},{a:'2-Step 10K',n:'$97',o:'$139'},{a:'2-Step 25K',n:'$174',o:'$249'},{a:'2-Step 50K',n:'$314',o:'$449'},{a:'2-Step 100K',n:'$482',o:'$689'},{a:'3-Step 2.5K',n:'$1',o:'—'},{a:'3-Step 5K',n:'$2',o:'—'},{a:'3-Step 10K',n:'$4',o:'—'},{a:'3-Step 25K',n:'$10',o:'—'},{a:'3-Step 50K',n:'$20',o:'—'},{a:'3-Step 100K',n:'$40',o:'—'},{a:'Instant 2.5K',n:'$62',o:'$89'},{a:'Instant 5K',n:'$111',o:'$159'},{a:'Instant 10K',n:'$216',o:'$309'},{a:'Instant 20K',n:'$391',o:'$559'},{a:'Instant 40K',n:'$741',o:'$1,059'},{a:'Instant 80K',n:'$1,315',o:'$1,879'},{a:'Pro 5K',n:'$263',o:'$329'},{a:'Pro 10K',n:'$527',o:'$659'},{a:'Pro 20K',n:'$1,055',o:'$1,319'},{a:'Pro 40K',n:'$2,111',o:'$2,639'},{a:'Pro 80K',n:'$4,223',o:'$5,279'}],perks:['5 programs: 1-Step, 2-Step, 3-Step, Instant, Instant Pro','Up to 100% profit share','CTI Academy Access included','No time limit','3-Step starts at $1','Instant funding available','No daily drawdown (1-Step)','Min 3 profitable days'],proibido:['HFT','Latency arbitrage','Hedging between accounts'],newsTrading:true,day1Payout:false,leverage:'1:30',consistency:'Not required',payoutSpeed:'Bi-weekly',maxAccounts:'5',desc:'City Traders Imperium (CTI) offers 5 evaluation programs with up to 100% profit split. Best MatchTrader Prop Firm 2025.',trustpilot:{score:4.3,reviews:1681,url:'https://www.trustpilot.com/review/citytradersimperium.com'}},
];
...
async function openGuideArticle(slug){
  ...
  if(typeof fbq==='function') fbq('track','ViewContent',{content_ids:[guide.id],content_type:'product',content_name:guide.title,content_category:'guide',value:0,currency:'USD'},{eventID:window._lastTrackId});
...
function openD(id){
  ...
  if(typeof fbq==='function') fbq('track','ViewContent',{content_ids:[id],content_type:'product',content_name:f.name,content_category:'firm',value:0,currency:'USD'},{eventID:window._lastTrackId});
...
function cpCoupon(code,firmId,loc){
  ...
  if(typeof fbq==='function') fbq('trackCustom','CopyCode',{content_ids:[firmId],content_name:f?.name||firmId,content_category:'firm',coupon:code,value:_fbVal(f),currency:'USD'},{eventID:window._lastTrackId});
...
const CHECKOUT_FIRMS=[
  ...
  {id:'fn',name:'FundedNext',short:'FundedNext',coupon:'FNF30',discount:'30%',color:'#06B6D4',bg:'rgba(6,182,212,0.12)',
   ...
   plansByType:{
     'Stellar 2-Step':[{size:'25K',capital:'$25,000',goal:'$2,000',maxDD:'-10%',orig:'$189.99',disc:'$132.99',featured:false},{size:'50K',capital:'$50,000',goal:'$4,000',maxDD:'-10%',orig:'$269.99',disc:'$188.99',featured:true},{size:'100K',capital:'$100,000',goal:'$8,000',maxDD:'-10%',orig:'$499.99',disc:'$349.99',featured:false}],
     'Stellar 1-Step':[{size:'25K',capital:'$25,000',goal:'$2,500',maxDD:'-4%',orig:'$239.99',disc:'$167.99',featured:false},{size:'50K',capital:'$50,000',goal:'$5,000',maxDD:'-4%',orig:'$339.99',disc:'$237.99',featured:true},{size:'100K',capital:'$100,000',goal:'$10,000',maxDD:'-4%',orig:'$649.99',disc:'$454.99',featured:false}],
     'Stellar Instant':[{size:'5K',capital:'$5,000',goal:'—',maxDD:'-4%',orig:'$149.99',disc:'$104.99',featured:false},{size:'10K',capital:'$10,000',goal:'—',maxDD:'-4%',orig:'$299.99',disc:'$209.99',featured:false},{size:'20K',capital:'$20,000',goal:'—',maxDD:'-4%',orig:'$599.99',disc:'$419.99',featured:true}],
     'Bolt (Futures)':[{size:'50K',capital:'$50,000',goal:'$3,000',maxDD:'-4%',orig:'$99.99',disc:'$69.99',featured:true}],
     'Rapid (Futures)':[{size:'25K',capital:'$25,000',goal:'$2,000',maxDD:'-4%',orig:'$89.99',disc:'$62.99',featured:false},{size:'50K',capital:'$50,000',goal:'$3,000',maxDD:'-4%',orig:'$159.99',disc:'$111.99',featured:true},{size:'100K',capital:'$100,000',goal:'$6,000',maxDD:'-4%',orig:'$279.99',disc:'$195.99',featured:false}],
  ...
  {id:'e8',name:'E8 Markets',short:'E8',coupon:'MARKET',discount:'10%',color:'#FF4400',bg:'rgba(255,68,0,0.12)',
   ...
   plansByType:{
     ...
     'E8 One':[{size:'$5K',capital:'$5,000',goal:'$450',maxDD:'-6%',orig:'$60',disc:'$54',featured:false},{size:'$10K',capital:'$10,000',goal:'$900',maxDD:'-6%',orig:'$90',disc:'$81',featured:false},{size:'$25K',capital:'$25,000',goal:'$2,250',maxDD:'-6%',orig:'$170',disc:'$153',featured:false},{size:'$50K',capital:'$50,000',goal:'$4,500',maxDD:'-6%',orig:'$260',disc:'$234',featured:false},{size:'$100K',capital:'$100,000',goal:'$9,000',maxDD:'-6%',orig:'$488',disc:'$439',featured:true},{size:'$200K',capital:'$200,000',goal:'$18,000',maxDD:'-6%',orig:'$929',disc:'$836',featured:false},{size:'$400K',capital:'$400,000',goal:'$36,000',maxDD:'-6%',orig:'$1,799',disc:'$1,619',featured:false},{size:'$500K',capital:'$500,000',goal:'$45,000',maxDD:'-6%',orig:'$2,299',disc:'$2,069',featured:false}]
   },
...
async function unlockCalc(){
  ...
  if(typeof fbq==='function') fbq('track','Lead',{content_name:'Position Size Calculator',content_category:'tool',value:0,currency:'USD'},{eventID:window._lastTrackId});
...
function qfinish(){
  setTimeout(()=>{
    ...
    if(typeof fbq==='function') fbq('track','Lead',{content_ids:[rec.id],content_name:rec.name,content_category:'quiz',value:0,currency:'USD'},{eventID:window._lastTrackId});
...
async function saveLead(data) {
  ...
  if(typeof fbq==='function') fbq('track','Lead',{content_name:data.tool,content_category:'tool',value:0,currency:'USD'},{eventID:window._lastTrackId});
...
async function registerLoyalty() {
  ...
  if(typeof fbq==='function') fbq('track','CompleteRegistration',{content_name:'Loyalty Program',content_category:'loyalty',value:0,currency:'USD',status:true},{eventID:window._lastTrackId});
...
async function submitProof() {
  ...
  if(typeof fbq==='function') fbq('track','SubmitApplication',{content_name:firma,content_category:'loyalty_proof',value:0,currency:'USD'},{eventID:window._lastTrackId});
